import{d as m,r as g,c as y,j as f,a as t,b as p,e as v,y as d,f as r,o as x,z as h}from"./index-CTK3vSMT.js";import{_ as k}from"./PageHeader.vue_vue_type_script_setup_true_lang-DqoOAbKh.js";const S={class:"space-y-8"},w={class:"card p-4"},_={class:"flex flex-wrap items-center justify-between gap-4"},C={class:"flex flex-wrap gap-2"},T={class:"card p-6 space-y-4"},I={class:"code-block"},E={class:"card p-6 space-y-4"},D={class:"code-block"},N={class:"card p-6 space-y-4"},L={class:"code-block"},R={class:"card p-6 space-y-4"},U={class:"code-block"},O={class:"card p-6 space-y-4"},A={class:"code-block"},P=m({__name:"Sidebar",setup(V){const i=g(null),l=async(o,a)=>{await navigator.clipboard.writeText(o),i.value=a,setTimeout(()=>i.value=null,2e3)},s={navData:`// src/components/nav/data/navigation.ts
export type NavItem = {
  id: string;
  label: string;
  icon?: string;
