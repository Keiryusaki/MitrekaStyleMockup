import{d as D,r as g,i as C,c as l,j as m,a as t,e as h,y as s,k as j,U,F as _,A as I,u as T,C as P,b as L,f as M,o as i,q as $,z as R}from"./index-DiwQE97j.js";import{_ as y}from"./Pagination.vue_vue_type_script_setup_true_lang-L7Fbf2nP.js";import{_ as V}from"./PageHeader.vue_vue_type_script_setup_true_lang-CzeWLLsV.js";const A={class:"space-y-8"},B={class:"card p-6 space-y-4"},F={class:"flex flex-col items-center gap-4"},O={class:"text-sm opacity-70"},z={class:"code-inline"},G={class:"code-block"},q={class:"card p-6 space-y-4"},K={class:"grid grid-cols-1 md:grid-cols-3 gap-4"},W={class:"p-4 bg-base-200 rounded-box text-center"},H={class:"p-4 bg-base-200 rounded-box text-center"},J={class:"p-4 bg-base-200 rounded-box text-center"},Q={class:"card p-6 space-y-4"},X={class:"space-y-4"},Y={class:"flex items-center gap-2"},Z={class:"overflow-x-auto"},tt={class:"table table-sm w-full"},et={class:"flex items-center justify-between"},at={class:"text-sm opacity-60"},st={class:"code-block"},nt={class:"card p-6 space-y-4"},ot={class:"flex justify-center"},lt={class:"flex items-center gap-2"},it=["disabled"],dt={key:1,class:"px-1 opacity-50"},ct=["onClick"],rt={key:2,class:"px-1 opacity-50"},pt=["disabled"],ut={class:"text-center text-sm opacity-60"},bt={class:"code-block"},vt={class:"card p-6 space-y-4"},gt={class:"code-block mt-4"},p=10,mt=D({__name:"Pagination",setup(yt){const u=g(null),x=async(n,e)=>{await navigator.clipboard.writeText(n),u.value=e,setTimeout(()=>u.value=null,2e3)},k=g(1),w=g(10),f=Array.from({length:50},(n,e)=>({id:e+1,name:`Item ${e+1}`,status:e%3===0?"Active":e%3===1?"Pending":"Inactive"})),c=g(5),b=g(1),S=C(()=>{const n=(b.value-1)*c.value;return f.slice(n,n+c.value)}),N=C(()=>Math.ceil(f.length/c.value)),d={basic:`<template>
  <Pagination 
    :page="currentPage" 
    :pages="totalPages" 
