import { defineComponent as R, createElementBlock as k, openBlock as v, normalizeClass as $, createCommentVNode as N, renderSlot as W, createElementVNode as g, ref as ee, watch as ue, withKeys as _e, withModifiers as Be, createBlock as qe, Teleport as dt, createVNode as Ee, Transition as We, withCtx as Ke, toDisplayString as I, provide as Zt, inject as Qt, computed as L, normalizeStyle as ve, createTextVNode as yt, Fragment as pe, renderList as Se, unref as je, useSlots as Xt, resolveDynamicComponent as en, reactive as tn, withDirectives as nn, vModelText as on, onMounted as it, onBeforeUnmount as st, useAttrs as an, mergeProps as rn } from "vue";
...
const pn = ["disabled"], mn = {
...
}), Bn = { class: "loading-logo-wrapper" }, Ln = { class: "dots-container" }, $n = ["width", "height"], On = {
  key: 0,
  class: "loading-text"
}, Fn = /* @__PURE__ */ R({
  __name: "LoadingLogo",
  ...
  setup(t) {
    ...
    return (h, x) => (v(), qe(dt, { to: "body" }, [
      g("div", {
        ...
        (v(!0), k(pe, null, Se(je(a).toasts.value, (i) => (v(), k("div", {
          key: i.id,
  ...
  setup(t) {
    ...
    }, f = L(() => `tooltip-pos-${a.position}`), s = L(() => `tooltip-arrow-${a.position}`), h = L(() => `tooltip-variant-${a.variant}`);
    return (x, i) => (v(), k("span", {
      class: "tooltip-root",
      onMouseenter: d,
      onMouseleave: c,
      ...
      Ee(We, { name: "tooltip-fade" }, {
        default: Ke(() => [
          e.value && t.text ? (v(), k("span", {
            key: 0,
            class: $(["tooltip-content", [f.value, h.value]]),
            role: "tooltip"
          }, [
            yt(I(t.text) + " ", 1),
            g("span", {
              class: $(["tooltip-arrow", [s.value, h.value]])
            }, null, 2)
          ], 2)) : N("", !0)
        ]),
        _: 1
  ...
  setup(t) {
    const a = t, e = ee(!1), u = L(() => a.src && !e.value), d = L(() => a.fallback ? a.fallback.slice(0, 2).toUpperCase() : a.alt && a.alt !== "Avatar" ? a.alt.split(" ").map((m) => m[0]).slice(0, 2).join("").toUpperCase() : "?"), c = L(() => `avatar-size-${a.size}`), f = L(() => `avatar-color-${a.color}`), s = L(() => a.status ? `avatar-status-${a.status}` : ""), h = L(() => `avatar-status-size-${a.size}`), x = L(() => a.square ? "avatar-square" : "avatar-round"), i = () => {
      e.value = !0;
    };
    return (m, j) => (v(), k("span", Jn, [
      u.value ? (v(), k("img", {
        ...
        key: 1,
        class: $(["avatar-fallback", [c.value, f.value, x.value]])
      }, I(d.value), 3)),
      t.status ? (v(), k("span", {
        key: 2,
        class: $(["avatar-status", [s.value, h.value]])
      }, null, 2)) : N("", !0)
    ]));
  }
}), ga = /* @__PURE__ */ R({
  ...
  setup(t) {
    const a = t, e = Xt(), u = L(() => {
      ...
      return s ? s.length : 0;
    }), d = L(() => u.value <= a.max ? 0 : u.value - a.max), c = L(() => `avatar-size-${a.size}`), f = L(() => `avatar-group-space-${a.size}`);
    return (s, h) => (v(), k("div", {
      class: $(["avatar-group", f.value])
    }, [
      (v(!0), k(pe, null, Se(t.max, (x, i) => {
        var m, j;
        return v(), k(pe, { key: i }, [
          i < u.value ? (v(), qe(en((j = (m = je(e)).default) == null ? void 0 : j.call(m)[i]), { key: 0 })) : N("", !0)
        ], 64);
      }), 128)),
      d.value > 0 ? (v(), k("span", {
        key: 0,
  ...
  setup(t, { emit: a }) {
    ...
    const f = (m) => !e.activeHref || !m.href ? !1 : m.exact ? e.activeHref === m.href : e.activeHref.startsWith(m.href), s = (m) => {
      ...
      const j = c[m.id], D = ((S = m.children) == null ? void 0 : S.some(f)) ?? !1;
          ...
          D.children ? (v(), k(pe, { key: 1 }, [
            ...
            s(D) ? (v(), k("div", {
              ...
              (v(!0), k(pe, null, Se(D.children, (S) => (v(), k("a", {
                key: S.id,
                class: $(["sidebar-item sidebar-child", f(S) ? "is-active" : ""]),
                href: S.href || "#",
            ...
            key: 0,
            class: $(["sidebar-item", f(D) ? "is-active" : ""]),
            href: D.href || "#",
            title: t.collapsed ? D.label : void 0,
  ...
  setup(t) {
    const a = t, e = L(() => a.class || "w-5 h-5"), u = L(() => xt[a.name]), d = L(
...
function Re(t, a) {
  var e = F("div", "numInputWrapper"), u = F("input", "numInput " + t), d = F("span", "arrowUp"), c = F("span", "arrowDown");
...
var ot = function() {
  ...
  var a = t.config, e = a === void 0 ? Ce : a, u = t.l10n, d = u === void 0 ? Le : u, c = t.isMobile, f = c === void 0 ? !1 : c;
  return function(s, h, x) {
    var i = x || d;
    return e.formatDate !== void 0 && !f ? e.formatDate(s, h, i) : h.split("").map(function(m, j, D) {
  ...
  return function(c, f, s, h) {
    if (!(c !== 0 && !c)) {
      ...
      if (c instanceof Date)
        ...
        var j = f || (e || Ce).dateFormat, D = String(c).trim();
        if (D === "today")
          ...
          for (var S = void 0, _ = [], A = 0, Q = 0, J = ""; A < j.length; A++) {
            var ae = j[A], le = ae === "\\", we = j[A - 1] === "\\" || le;
            if (ye[ae] && !we) {
              J += ye[ae];
...
function Po(t, a) {
  ...
  e.parseDate = lt({ config: e.config, l10n: e.l10n }), e._handlers = [], e.pluginElements = [], e.loadedPlugins = [], e._bind = _, e._setHoursFromDate = j, e._positionCalendar = Ye, e.changeMonth = q, e.changeYear = Fe, e.clear = K, e.close = Oe, e.onMouseOver = Ne, e._createElement = F, e.createDay = re, e.destroy = _t, e.isEnabled = be, e.jumpToDate = J, e.updateValue = ge, e.open = jt, e.redraw = gt, e.set = Bt, e.setDate = Lt, e.toggle = It;
  function u() {
    e.utils = {
  ...
  function d() {
    e.element = e.input = t, e.isOpen = !1, Ht(), ht(), Ot(), $t(), u(), e.isMobile || we(), Q(), (e.selectedDates.length || e.config.noCalendar) && (e.config.enableTime && j(e.config.noCalendar ? e.latestSelectedDateObj : void 0), ge(!1)), s();
  ...
  function m() {
    if (!(e.hourElement === void 0 || e.minuteElement === void 0)) {
      ...
      if (e.config.maxTime !== void 0 && e.config.minTime !== void 0 && e.config.minTime > e.config.maxTime) {
        var w = at(e.config.minTime.getHours(), e.config.minTime.getMinutes(), e.config.minTime.getSeconds()), H = at(e.config.maxTime.getHours(), e.config.maxTime.getMinutes(), e.config.maxTime.getSeconds()), y = at(n, o, r);
        if (y > H && y < w) {
          var T = Io(w);
          n = T[0], o = T[1], r = T[2];
        }
  ...
  function we() {
    ...
    if (e.calendarContainer = F("div", "flatpickr-calendar"), e.calendarContainer.tabIndex = -1, !e.config.noCalendar) {
      if (n.appendChild(he()), e.innerContainer = F("div", "flatpickr-innerContainer"), e.config.weekNumbers) {
        var o = Y(), r = o.weekWrapper, l = o.weekNumbers;
        e.innerContainer.appendChild(r), e.weekNumbers = l, e.weekWrapper = r;
      }
      e.rContainer = F("div", "flatpickr-rContainer"), e.rContainer.appendChild($e()), e.daysContainer || (e.daysContainer = F("div", "flatpickr-days"), e.daysContainer.tabIndex = -1), O(), e.rContainer.appendChild(e.daysContainer), e.innerContainer.appendChild(e.rContainer), n.appendChild(e.innerContainer);
    }
  ...
  function re(n, o, r, l) {
    var p = be(o, !0), w = F("span", n, o.getDate().toString());
  ...
  function B(n, o) {
    ...
    var ce = F("div", "dayContainer");
    return ce.appendChild(w), ce;
  }
  function O() {
  ...
  function fe() {
    var n = F("div", "flatpickr-month"), o = window.document.createDocumentFragment(), r;
    e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? r = F("span", "cur-month") : (e.monthsDropdownContainer = F("select", "flatpickr-monthDropdown-months"), e.monthsDropdownContainer.setAttribute("aria-label", e.l10n.monthAriaLabel), _(e.monthsDropdownContainer, "change", function(H) {
      var y = ne(H), T = parseInt(y.value, 10);
  ...
  function he() {
    return e.monthNav = F("div", "flatpickr-months"), e.yearElements = [], e.monthElements = [], e.prevMonthNav = F("span", "flatpickr-prev-month"), e.prevMonthNav.innerHTML = e.config.prevArrow, e.nextMonthNav = F("span", "flatpickr-next-month"), e.nextMonthNav.innerHTML = e.config.nextArrow, xe(), Object.defineProperty(e, "_hidePrevMonthArrow", {
      get: function() {
  ...
  function ke() {
    ...
    var o = F("span", "flatpickr-time-separator", ":"), r = Re("flatpickr-hour", {
    ...
    if (e.minuteElement = l.getElementsByTagName("input")[0], e.hourElement.tabIndex = e.minuteElement.tabIndex = -1, e.hourElement.value = X(e.latestSelectedDateObj ? e.latestSelectedDateObj.getHours() : e.config.time_24hr ? n.hours : i(n.hours)), e.minuteElement.value = X(e.latestSelectedDateObj ? e.latestSelectedDateObj.getMinutes() : n.minutes), e.hourElement.setAttribute("step", e.config.hourIncrement.toString()), e.minuteElement.setAttribute("step", e.config.minuteIncrement.toString()), e.hourElement.setAttribute("min", e.config.time_24hr ? "0" : "1"), e.hourElement.setAttribute("max", e.config.time_24hr ? "23" : "12"), e.hourElement.setAttribute("maxlength", "2"), e.minuteElement.setAttribute("min", "0"), e.minuteElement.setAttribute("max", "59"), e.minuteElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(r), e.timeContainer.appendChild(o), e.timeContainer.appendChild(l), e.config.time_24hr && e.timeContainer.classList.add("time24hr"), e.config.enableSeconds) {
      ...
      e.secondElement = p.getElementsByTagName("input")[0], e.secondElement.value = X(e.latestSelectedDateObj ? e.latestSelectedDateObj.getSeconds() : n.seconds), e.secondElement.setAttribute("step", e.minuteElement.getAttribute("step")), e.secondElement.setAttribute("min", "0"), e.secondElement.setAttribute("max", "59"), e.secondElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(F("span", "flatpickr-time-separator", ":")), e.timeContainer.appendChild(p);
    }
    return e.config.time_24hr || (e.amPM = F("span", "flatpickr-am-pm", e.l10n.amPM[se((e.latestSelectedDateObj ? e.hourElement.value : e.config.defaultHour) > 11)]), e.amPM.title = e.l10n.toggleTitle, e.amPM.tabIndex = -1, e.timeContainer.appendChild(e.amPM)), e.timeContainer;
  }
  function $e() {
    e.weekdayContainer ? Ve(e.weekdayContainer) : e.weekdayContainer = F("div", "flatpickr-weekdays");
    for (var n = e.config.showMonths; n--; ) {
      var o = F("div", "flatpickr-weekdaycontainer");
  ...
  function q(n, o) {
    ...
    r < 0 && e._hidePrevMonthArrow === !0 || r > 0 && e._hideNextMonthArrow === !0 || (e.currentMonth += r, (e.currentMonth < 0 || e.currentMonth > 11) && (e.currentYear += e.currentMonth > 11 ? 1 : -1, e.currentMonth = (e.currentMonth + 12) % 12, V("onYearChange"), z()), O(), V("onMonthChange"), ze());
  }
  function K(n, o) {
  ...
  function Ue(n) {
    if (e.isOpen && !e.config.inline) {
      var o = ne(n), r = He(o), l = o === e.input || o === e.altInput || e.element.contains(o) || n.path && n.path.indexOf && (~n.path.indexOf(e.input) || ~n.path.indexOf(e.altInput)), p = !l && !r && !He(n.relatedTarget), w = !e.config.ignoredFocusElements.some(function(H) {
        return H.contains(o);
      });
    ...
    if (n.keyCode === 13 && r) {
      ...
      switch (n.keyCode) {
        ...
        case 40:
          ...
          e.daysContainer && o.$i !== void 0 || o === e.input || o === e.altInput ? n.ctrlKey ? (n.stopPropagation(), Fe(e.currentYear - b), M(de(1), 0)) : H || M(void 0, b * 7) : o === e.currentYearElement ? Fe(e.currentYear - b) : e.config.enableTime && (!H && e.hourElement && e.hourElement.focus(), h(n), e._debouncedChange());
          break;
        case 9:
          if (H) {
            var E = [
            ...
            if (P !== -1) {
              var ce = E[P + (n.shiftKey ? -1 : 1)];
              n.preventDefault(), (ce || e._input).focus();
            }
  ...
  function Ne(n, o) {
    if (o === void 0 && (o = "flatpickr-day"), !(e.selectedDates.length !== 1 || n && (!n.classList.contains(o) || n.classList.contains("flatpickr-disabled")))) {
      for (var r = n ? n.dateObj.getTime() : e.days.firstElementChild.dateObj.getTime(), l = e.parseDate(e.selectedDates[0], void 0, !0).getTime(), p = Math.min(r, e.selectedDates[0].getTime()), w = Math.max(r, e.selectedDates[0].getTime()), H = !1, y = 0, T = 0, b = p; b < w; b += No.DAY)
        be(new Date(b), !0) || (H = H || b > p && b < w, b < l && (!y || b > y) ? y = b : b > l && (!T || b < T) && (T = b));
      var E = Array.from(e.rContainer.querySelectorAll("*:nth-child(-n+" + e.config.showMonths + ") > ." + o));
      E.forEach(function(P) {
        var ce = P.dateObj, te = ce.getTime(), Te = y > 0 && te < y || T > 0 && te > T;
        if (Te) {
        ...
        ["startRange", "inRange", "endRange", "notAllowed"].forEach(function(Me) {
          P.classList.remove(Me);
        }), n !== void 0 && (n.classList.add(r <= e.selectedDates[0].getTime() ? "startRange" : "endRange"), l < r && te === l ? P.classList.add("startRange") : l > r && te === l && P.classList.add("endRange"), te >= y && (T === 0 || te <= T) && Fo(te, l, r) && P.classList.add("inRange"));
      });
    }
  }
  function St() {
  ...
  function ut(n) {
    return function(o) {
      ...
      r !== void 0 && (e[n === "min" ? "minDateHasTime" : "maxDateHasTime"] = r.getHours() > 0 || r.getMinutes() > 0 || r.getSeconds() > 0), e.selectedDates && (e.selectedDates = e.selectedDates.filter(function(p) {
        return be(p);
      }), !e.selectedDates.length && n === "min" && j(r), ge()), e.daysContainer && (gt(), r !== void 0 ? e.currentYearElement[n] = r.getFullYear().toString() : e.currentYearElement.removeAttribute(n), e.currentYearElement.disabled = !!l && r !== void 0 && l.getFullYear() === r.getFullYear());
    };
  }
  function Ht() {
    var n = [
  ...
  function Ye(n) {
    ...
    if (e.calendarContainer !== void 0) {
      ...
      if (Z(e.calendarContainer, "arrowTop", !b), Z(e.calendarContainer, "arrowBottom", b), !e.config.inline) {
        var P = window.pageXOffset + y.left, ce = !1, te = !1;
        H === "center" ? (P -= (l - y.width) / 2, ce = !0) : H === "right" && (P -= l - y.width, te = !0), Z(e.calendarContainer, "arrowLeft", !ce && !te), Z(e.calendarContainer, "arrowCenter", ce), Z(e.calendarContainer, "arrowRight", te);
  ...
  function gt() {
    e.config.noCalendar || e.isMobile || (z(), ze(), O());
  }
  function Je() {
  ...
  function pt(n) {
    ...
    if (r !== void 0) {
      ...
      if (ze(), O(), ge(), !w && e.config.mode !== "range" && e.config.showMonths === 1 ? ie(l) : e.selectedDateElem !== void 0 && e.hourElement === void 0 && e.selectedDateElem && e.selectedDateElem.focus(), e.hourElement !== void 0 && e.hourElement !== void 0 && e.hourElement.focus(), e.config.closeOnSelect) {
  ...
  function Lt(n, o, r) {
    if (o === void 0 && (o = !1), r === void 0 && (r = e.config.dateFormat), n !== 0 && !n || n instanceof Array && n.length === 0)
      return e.clear(o);
    mt(n, r), e.latestSelectedDateObj = e.selectedDates[e.selectedDates.length - 1], e.redraw(), J(void 0, o), j(), e.selectedDates.length === 0 && e.clear(!1), ge(o), o && V("onChange");
  }
  function vt(n) {
  ...
  function Pt(n) {
    ...
    if (typeof l.value < "u" && l.value.length === 2) {
      ...
      b < p ? (b = w + b + se(!E) + (se(E) && se(!e.amPM)), P && le(void 0, -1, e.hourElement)) : b > w && (b = l === e.hourElement ? b - w - se(!e.amPM) : p, P && le(void 0, 1, e.hourElement)), e.amPM && E && (H === 1 ? b + y === 23 : Math.abs(b - y) > H) && (e.amPM.textContent = e.l10n.amPM[se(e.amPM.textContent === e.l10n.amPM[0])]), l.value = X(b);
    }
  }
  return d(), e;
}
      ...
      return function(i) {
        ...
        function S() {
          if (m.monthsContainer) {
            ...
            for (var M = document.createDocumentFragment(), B = 0; B < 12; B++) {
              ...
              O.dateObj.getMonth() === (/* @__PURE__ */ new Date()).getMonth() && O.dateObj.getFullYear() === (/* @__PURE__ */ new Date()).getFullYear() && O.classList.add("today"), O.textContent = u(B, x.shorthand, i.l10n), O.addEventListener("click", J), M.appendChild(O);
            }
        ...
        function A() {
          if (i.rContainer && i.selectedDates.length) {
            ...
            var O = i.selectedDates[0].getMonth(), z = i.rContainer.querySelector(".flatpickr-monthSelect-month:nth-child(" + (O + 1) + ")");
        ...
        function J(M) {
          ...
          if (B instanceof Element && !B.classList.contains("flatpickr-disabled") && !B.classList.contains("notAllowed") && (ae(B.dateObj), i.config.closeOnSelect)) {
            var O = i.config.mode === "single", z = i.config.mode === "range" && i.selectedDates.length === 2;
            (O || z) && i.close();
          }
        }
        function ae(M) {
          var B = new Date(i.currentYear, M.getMonth(), M.getDate()), O = [];
          switch (i.config.mode) {
            ...
            case "multiple":
              ...
              break;
            case "range":
              i.selectedDates.length === 2 ? O = [B] : (O = i.selectedDates.concat([B]), O.sort(function(z, fe) {
...
const Wo = /* @__PURE__ */ Vo(Ro), Ko = { class: "relative" }, Go = ["placeholder", "disabled", "readonly"], qo = {
  ...
  setup(t, { emit: a }) {
    ...
    let s = null;
    const h = L(() => e.picker === "month" ? e.dateFormat || "Y-m" : e.picker === "year" ? e.dateFormat || "Y" : e.dateFormat ? e.dateFormat : e.noCalendar ? "H:i" : e.enableTime ? "Y-m-d H:i" : "Y-m-d"), x = () => {
      var S, _;
      if (d.value) {
  ...
  setup(t, { emit: a }) {
    ...
    let x = null, i = null;
    const m = ["modelUpdated", "paginationChanged", "filterChanged", "rowDataUpdated"], j = [], D = ee("normal"), S = L(() => [
      "w-full",
      ...
      h.value = Y || q;
    }, Q = L(() => e.themeMode === "dark" ? !0 : e.themeMode === "light" ? !1 : h.value), J = L(() => Q.value ? "ag-theme-quartz-dark" : "ag-theme-quartz"), ae = L(() => e.density === "compact" ? "agx-compact" : e.density === "spacious" ? "agx-spacious" : ""), le = L(() => ["agx", J.value, ae.value, d.class]), we = L(() => [{ "--ag-odd-row-background-color": e.striped ? Q.value ? "#0d1a33" : "#F3F4F6" : "transparent" }, d.style]), re = L(() => {
      const { class: C, style: Y, onGridReady: q, ...K } = d;
      return K;
    }), ie = (C) => typeof C == "number" && Number.isFinite(C) ? C : void 0, de = L(() => {
      ...
      if (typeof f.value.getModel == "function") {
        const K = (q = (Y = f.value).getModel) == null ? void 0 : q.call(Y), Oe = K && typeof K.getRowCount == "function" ? K.getRowCount() : void 0;
        if (C(Oe)) return Oe;
      }
      return 0;
    }, O = () => {
      ...
      const Y = e.autoHeightWhenFewRows && B() < O() ? "autoHeight" : "normal";
      ...
      const C = () => z();
      m.forEach((Y) => {
        f.value.addEventListener(Y, C), j.push(() => {
          var q;
      ...
      f.value = C.api, s.value = hn(c.value), xe(), he(), z(), ke(), u("grid-ready", C);
    };
    return ue(
      () => e.density,
      () => {
