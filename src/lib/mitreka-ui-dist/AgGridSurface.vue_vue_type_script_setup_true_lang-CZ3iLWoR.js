import { defineComponent as V, createElementBlock as k, openBlock as v, normalizeClass as L, createCommentVNode as N, renderSlot as W, createElementVNode as g, ref as Q, watch as ce, withKeys as _e, withModifiers as Be, createBlock as Ke, Teleport as st, createVNode as Ee, Transition as Ve, withCtx as Re, toDisplayString as I, provide as Zt, inject as Qt, computed as F, normalizeStyle as be, createTextVNode as kt, Fragment as fe, renderList as Se, unref as je, useSlots as Xt, resolveDynamicComponent as en, reactive as tn, withDirectives as nn, vModelText as on, onMounted as at, onBeforeUnmount as rt, useAttrs as an, mergeProps as rn } from "vue";
...
const pn = ["disabled"], mn = {
  ...
  setup(t, { expose: a, emit: e }) {
    const u = t, d = e, c = Q(u.modelValue !== void 0 ? u.modelValue : u.defaultOpen);
    ce(() => u.modelValue, (s) => {
      s !== void 0 && (c.value = s);
    });
    function h() {
    ...
    return a({ isOpen: c, toggle: h }), (s, f) => (v(), k("section", {
      ...
      s.$slots.title ? (v(), k("header", {
        ...
        t.collapsible ? (v(), k("svg", {
          key: 0,
          class: L(["card-collapse-icon", { "is-open": c.value }]),
      ...
      t.collapsible ? (v(), k("div", {
        key: 1,
        class: L(["card-body-wrapper", { "is-open": c.value }])
      }, [
        g("div", kn, [
          W(s.$slots, "default")
        ])
...
}, xn = { class: "text-xl font-semibold" }, ra = /* @__PURE__ */ V({
  __name: "Modal",
  props: {
    open: { type: Boolean },
    title: { default: "Modal" },
...
}), Mn = ["aria-expanded", "aria-disabled", "onKeydown"], Cn = { class: "collapse-title" }, Dn = { class: "collapse-content" }, _n = { class: "collapse-content-inner" }, En = { class: "collapse-body" }, ia = /* @__PURE__ */ V({
  __name: "Collapse",
  props: {
    modelValue: { type: Boolean, default: void 0 },
  ...
  setup(t, { expose: a, emit: e }) {
    const u = t, d = e, c = Q(/* @__PURE__ */ new Set());
    ce(() => u.modelValue, (f) => {
...
}), Sn = ["aria-expanded", "aria-disabled", "onKeydown"], jn = { class: "accordion-title" }, Tn = { class: "accordion-content" }, Hn = { class: "accordion-content-inner" }, An = { class: "accordion-body" }, la = /* @__PURE__ */ V({
  ...
  setup(t) {
    const a = t, e = Qt("accordion"), u = F(() => (e == null ? void 0 : e.isItemOpen(a.id)) ?? !1);
    function d() {
  ...
  setup(t) {
    const a = t, e = F(() => Math.round(a.size * (8 / 60)));
  ...
  key: 0,
  class: "toast-title"
}, Rn = { class: "toast-message" }, Wn = ["onClick"], ca = /* @__PURE__ */ V({
  __name: "Toasts",
  setup(t) {
    const a = sn(), e = F(() => {
      const f = {
    ...
    return (f, x) => (v(), Ke(st, { to: "body" }, [
      g("div", {
        class: L(["toast-container", e.value])
      }, [
        (v(!0), k(fe, null, Se(je(a).toasts.value, (i) => (v(), k("div", {
          key: i.id,
  ...
  setup(t) {
    ...
    }, h = F(() => `tooltip-pos-${a.position}`), s = F(() => `tooltip-arrow-${a.position}`), f = F(() => `tooltip-variant-${a.variant}`);
    return (x, i) => (v(), k("span", {
      class: "tooltip-root",
      onMouseenter: d,
      onMouseleave: c,
      ...
      W(x.$slots, "default"),
      Ee(Ve, { name: "tooltip-fade" }, {
        default: Re(() => [
          e.value && t.text ? (v(), k("span", {
            key: 0,
            class: L(["tooltip-content", [h.value, f.value]]),
            role: "tooltip"
          }, [
            kt(I(t.text) + " ", 1),
            g("span", {
              class: L(["tooltip-arrow", [s.value, f.value]])
            }, null, 2)
          ], 2)) : N("", !0)
        ]),
        _: 1
...
}), Kn = { class: "mitreka-pagination" }, Gn = ["disabled"], qn = { class: "pagination-status" }, Un = ["disabled"], fa = /* @__PURE__ */ V({
  __name: "Pagination",
  props: {
    page: {},
    pages: {}
...
}), Jn = { class: "avatar-root" }, Zn = ["src", "alt"], ha = /* @__PURE__ */ V({
  __name: "Avatar",
  props: {
    src: {},
    alt: { default: "Avatar" },
  ...
  setup(t) {
    const a = t, e = Q(!1), u = F(() => a.src && !e.value), d = F(() => a.fallback ? a.fallback.slice(0, 2).toUpperCase() : a.alt && a.alt !== "Avatar" ? a.alt.split(" ").map((m) => m[0]).slice(0, 2).join("").toUpperCase() : "?"), c = F(() => `avatar-size-${a.size}`), h = F(() => `avatar-color-${a.color}`), s = F(() => a.status ? `avatar-status-${a.status}` : ""), f = F(() => `avatar-status-size-${a.size}`), x = F(() => a.square ? "avatar-square" : "avatar-round"), i = () => {
      e.value = !0;
    };
    return (m, j) => (v(), k("span", Jn, [
      u.value ? (v(), k("img", {
        ...
        src: t.src,
        alt: t.alt,
        class: L(["avatar-img", [c.value, x.value]]),
        onError: i
      }, null, 42, Zn)) : (v(), k("span", {
        key: 1,
        class: L(["avatar-fallback", [c.value, h.value, x.value]])
      }, I(d.value), 3)),
      t.status ? (v(), k("span", {
        key: 2,
        class: L(["avatar-status", [s.value, f.value]])
      }, null, 2)) : N("", !0)
    ]));
  }
}), ga = /* @__PURE__ */ V({
  ...
  setup(t) {
    const a = t, e = Xt(), u = F(() => {
      ...
      return s ? s.length : 0;
    }), d = F(() => u.value <= a.max ? 0 : u.value - a.max), c = F(() => `avatar-size-${a.size}`), h = F(() => `avatar-group-space-${a.size}`);
    return (s, f) => (v(), k("div", {
      class: L(["avatar-group", h.value])
    }, [
      (v(!0), k(fe, null, Se(t.max, (x, i) => {
        var m, j;
        return v(), k(fe, { key: i }, [
          i < u.value ? (v(), Ke(en((j = (m = je(e)).default) == null ? void 0 : j.call(m)[i]), { key: 0 })) : N("", !0)
        ], 64);
      }), 128)),
      d.value > 0 ? (v(), k("span", {
        key: 0,
        class: L(["avatar-group-count", c.value])
      }, " +" + I(d.value), 3)) : N("", !0)
    ], 2));
  }
}), Qn = {
  ...
  setup(t) {
    ...
    return (u, d) => t.items.length ? (v(), k("nav", Qn, [
      g("ol", Xn, [
        ...
        (v(!0), k(fe, null, Se(t.items, (c, h) => (v(), k("li", {
          key: h,
          class: "breadcrumbs-item"
        }, [
  ...
  key: 0,
  class: "stat-icon"
}, lo = { class: "stat-content" }, co = { class: "stat-label" }, uo = { class: "stat-value" }, ma = /* @__PURE__ */ V({
  __name: "StatCard",
  props: {
    icon: {},
    label: {},
...
}), mo = { class: "mitreka-theme-switcher" }, vo = ["value"], wa = /* @__PURE__ */ V({
  __name: "ThemeSwitcher",
  setup(t) {
    const { mode: a, setTheme: e, toggleTheme: u } = ln("light"), d = F(
  ...
  key: 0,
  class: "sidebar-label"
}, To = ["href", "title", "onClick"], Ho = { class: "sidebar-icon" }, Ao = { class: "sidebar-icon-text" }, Bo = {
  key: 0,
  class: "sidebar-label"
}, ka = /* @__PURE__ */ V({
  __name: "Sidebar",
  ...
  setup(t, { emit: a }) {
    ...
    const h = (m) => !e.activeHref || !m.href ? !1 : m.exact ? e.activeHref === m.href : e.activeHref.startsWith(m.href), s = (m) => {
      ...
      const j = c[m.id], _ = ((S = m.children) == null ? void 0 : S.some(h)) ?? !1;
      return j === void 0 && _ && (c[m.id] = !0), c[m.id] ?? _;
    }, f = (m) => {
      const j = !s(m);
      ...
      return m ? e.items.map((j) => {
        if (j.children) {
          ...
          return j.label.toLowerCase().includes(m) ? j : _.length > 0 ? { ...j, children: _ } : null;
        }
    ...
    return (m, j) => (v(), k("aside", {
      ...
      t.showSearch && !t.collapsed ? (v(), k("div", ko, [
        ...
        d.value ? (v(), k("button", {
          ...
          onClick: j[1] || (j[1] = (_) => d.value = "")
        }, " × ")) : N("", !0)
      ])) : N("", !0),
      g("nav", yo, [
        (v(!0), k(fe, null, Se(x.value, (_) => (v(), k(fe, {
          key: _.id
        }, [
          _.children ? (v(), k(fe, { key: 1 }, [
            g("button", {
              class: L(["sidebar-item sidebar-group", s(_) ? "is-open" : ""]),
              title: t.collapsed ? _.label : void 0,
              onClick: (S) => f(_)
            }, [
              g("span", Eo, [
                W(m.$slots, "icon", { item: _ }, () => [
                  g("span", So, I(_.icon || "•"), 1)
                ])
              ]),
              t.collapsed ? N("", !0) : (v(), k("span", jo, I(_.label), 1)),
              t.collapsed ? N("", !0) : (v(), k("span", {
                key: 1,
                class: L(["sidebar-caret", s(_) ? "rotate" : ""])
              }, "›", 2))
            ], 10, _o),
            s(_) ? (v(), k("div", {
              key: 0,
              ...
              (v(!0), k(fe, null, Se(_.children, (S) => (v(), k("a", {
                key: S.id,
                class: L(["sidebar-item sidebar-child", h(S) ? "is-active" : ""]),
                href: S.href || "#",
                title: t.collapsed ? S.label : void 0,
                onClick: Be((D) => i(S), ["prevent"])
              }, [
                g("span", Ho, [
            ...
            key: 0,
            class: L(["sidebar-item", h(_) ? "is-active" : ""]),
            href: _.href || "#",
            title: t.collapsed ? _.label : void 0,
            onClick: Be((S) => i(_), ["prevent"])
          }, [
            g("span", Mo, [
              W(m.$slots, "icon", { item: _ }, () => [
                g("span", Co, I(_.icon || "•"), 1)
              ])
            ]),
            t.collapsed ? N("", !0) : (v(), k("span", Do, I(_.label), 1))
          ], 10, xo))
        ], 64))), 128))
      ])
    ], 2));
  ...
  setup(t) {
    const a = t, e = F(() => a.class || "w-5 h-5"), u = F(() => bt[a.name]), d = F(
...
var tt = function() {
  ...
  K: function(t, a, e) {
    t.setHours(t.getHours() % 12 + 12 * re(new RegExp(e.amPM[1], "i").test(a)));
  },
  M: function(t, a, e) {
  ...
  K: function(t, a) {
    return a.amPM[re(t.getHours() > 11)];
  },
  M: function(t, a) {
    return We(t.getMonth(), !0, a);
  },
  S: function(t) {
  ...
  var a = t.config, e = a === void 0 ? Ce : a, u = t.l10n, d = u === void 0 ? $e : u, c = t.isMobile, h = c === void 0 ? !1 : c;
  return function(s, f, x) {
    var i = x || d;
    return e.formatDate !== void 0 && !h ? e.formatDate(s, f, i) : f.split("").map(function(m, j, _) {
      return Ae[m] && _[j - 1] !== "\\" ? Ae[m](s, i, e) : m !== "\\" ? m : "";
    }).join("");
  };
}, it = function(t) {
  ...
  return function(c, h, s, f) {
    if (!(c !== 0 && !c)) {
      ...
      if (c instanceof Date)
        ...
        var j = h || (e || Ce).dateFormat, _ = String(c).trim();
        if (_ === "today")
          ...
          for (var S = void 0, D = [], A = 0, X = 0, q = ""; A < j.length; A++) {
            var oe = j[A], ie = oe === "\\", ve = j[A - 1] === "\\" || ie;
            if (ye[oe] && !ve) {
              q += ye[oe];
              var J = new RegExp(q).exec(c);
              J && (S = !0) && D[oe !== "Y" ? "push" : "unshift"]({
                fn: Lo[oe],
                val: J[++X]
              });
            } else ie || (q += ".");
          }
          i = !e || !e.noCalendar ? new Date((/* @__PURE__ */ new Date()).getFullYear(), 0, 1, 0, 0, 0, 0) : new Date((/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0)), D.forEach(function(se) {
            var le = se.fn, we = se.val;
            return i = le(i, we, x) || i;
          }), i = S ? i : void 0;
        }
      }
...
function Po(t, a) {
  ...
  e.parseDate = it({ config: e.config, l10n: e.l10n }), e._handlers = [], e.pluginElements = [], e.loadedPlugins = [], e._bind = D, e._setHoursFromDate = j, e._positionCalendar = Ie, e.changeMonth = me, e.changeYear = Fe, e.clear = Ct, e.close = Dt, e.onMouseOver = Oe, e._createElement = O, e.createDay = J, e.destroy = _t, e.isEnabled = ke, e.jumpToDate = q, e.updateValue = ue, e.open = jt, e.redraw = ft, e.set = Bt, e.setDate = $t, e.toggle = It;
  function u() {
    e.utils = {
  ...
  function d() {
    e.element = e.input = t, e.isOpen = !1, Tt(), ut(), Lt(), Ft(), u(), e.isMobile || ve(), X(), (e.selectedDates.length || e.config.noCalendar) && (e.config.enableTime && j(e.config.noCalendar ? e.latestSelectedDateObj : void 0), ue(!1)), s();
    var n = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
    !e.isMobile && n && Ie(), z("onReady");
  }
  function c() {
    var n;
  ...
  function f(n) {
    if (e.selectedDates.length === 0) {
      var o = e.config.minDate === void 0 || ne(/* @__PURE__ */ new Date(), e.config.minDate) >= 0 ? /* @__PURE__ */ new Date() : new Date(e.config.minDate.getTime()), r = ot(e.config);
    ...
    m(), ue(), e._input.value !== l && e._debouncedChange();
  }
  function x(n, o) {
    return n % 12 + 12 * re(o === e.l10n.amPM[1]);
  }
  function i(n) {
    switch (n % 24) {
      case 0:
  ...
  function m() {
    if (!(e.hourElement === void 0 || e.minuteElement === void 0)) {
      ...
      if (e.config.maxTime !== void 0 && e.config.minTime !== void 0 && e.config.minTime > e.config.maxTime) {
        var w = nt(e.config.minTime.getHours(), e.config.minTime.getMinutes(), e.config.minTime.getSeconds()), T = nt(e.config.maxTime.getHours(), e.config.maxTime.getMinutes(), e.config.maxTime.getSeconds()), y = nt(n, o, r);
        if (y > T && y < w) {
          var H = Io(w);
          n = H[0], o = H[1], r = H[2];
        }
  ...
  function _(n, o, r) {
    e.latestSelectedDateObj !== void 0 && e.latestSelectedDateObj.setHours(n % 24, o, r || 0, 0), !(!e.hourElement || !e.minuteElement || e.isMobile) && (e.hourElement.value = Z(e.config.time_24hr ? n : (12 + n) % 12 + 12 * re(n % 12 === 0)), e.minuteElement.value = Z(o), e.amPM !== void 0 && (e.amPM.textContent = e.l10n.amPM[re(n >= 12)]), e.secondElement !== void 0 && (e.secondElement.value = Z(r)));
  }
  function S(n) {
  ...
  function X() {
    ...
    var n = vt(St, 50);
    if (e._debouncedChange = vt(A, Yo), e.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && D(e.daysContainer, "mouseover", function(r) {
      e.config.mode === "range" && Oe(te(r));
    }), D(e._input, "keydown", lt), e.calendarContainer !== void 0 && D(e.calendarContainer, "keydown", lt), !e.config.inline && !e.config.static && D(window, "resize", n), window.ontouchstart !== void 0 ? D(window.document, "touchstart", Ge) : D(window.document, "mousedown", Ge), D(window.document, "focus", Ge, { capture: !0 }), e.config.clickOpens === !0 && (D(e._input, "focus", e.open), D(e._input, "click", e.open)), e.daysContainer !== void 0 && (D(e.monthNav, "click", Yt), D(e.monthNav, ["keyup", "increment"], S), D(e.daysContainer, "click", ht)), e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0) {
      var o = function(r) {
        return te(r).select();
      };
      D(e.timeContainer, ["increment"], f), D(e.timeContainer, "blur", f, { capture: !0 }), D(e.timeContainer, "click", oe), D([e.hourElement, e.minuteElement], ["focus", "click"], o), e.secondElement !== void 0 && D(e.secondElement, "focus", function() {
        return e.secondElement && e.secondElement.select();
      }), e.amPM !== void 0 && D(e.amPM, "click", function(r) {
        f(r);
      });
    }
    e.config.allowInput && D(e._input, "blur", Et);
  }
  function q(n, o) {
    ...
    o && e.currentYear !== l && (z("onYearChange"), R()), o && (e.currentYear !== l || e.currentMonth !== p) && z("onMonthChange"), e.redraw();
  }
  function oe(n) {
    var o = te(n);
    ~o.className.indexOf("arrow") && ie(n, o.classList.contains("arrowUp") ? 1 : -1);
  }
  function ie(n, o, r) {
    var l = n && te(n), p = r || l && l.parentNode && l.parentNode.firstChild, w = Ue("increment");
  ...
  function ve() {
    ...
    if (e.calendarContainer = O("div", "flatpickr-calendar"), e.calendarContainer.tabIndex = -1, !e.config.noCalendar) {
      if (n.appendChild(pe()), e.innerContainer = O("div", "flatpickr-innerContainer"), e.config.weekNumbers) {
        var o = ae(), r = o.weekWrapper, l = o.weekNumbers;
        e.innerContainer.appendChild(r), e.weekNumbers = l, e.weekWrapper = r;
      }
      e.rContainer = O("div", "flatpickr-rContainer"), e.rContainer.appendChild(M()), e.daysContainer || (e.daysContainer = O("div", "flatpickr-days"), e.daysContainer.tabIndex = -1), $(), e.rContainer.appendChild(e.daysContainer), e.innerContainer.appendChild(e.rContainer), n.appendChild(e.innerContainer);
    }
    e.config.enableTime && n.appendChild(xe()), U(e.calendarContainer, "rangeMode", e.config.mode === "range"), U(e.calendarContainer, "animate", e.config.animate === !0), U(e.calendarContainer, "multiMonth", e.config.showMonths > 1), e.calendarContainer.appendChild(n);
  ...
  function J(n, o, r, l) {
    ...
    return w.dateObj = o, w.$i = l, w.setAttribute("aria-label", e.formatDate(o, e.config.ariaDateFormat)), n.indexOf("hidden") === -1 && ne(o, e.now) === 0 && (e.todayDateElem = w, w.classList.add("today"), w.setAttribute("aria-current", "date")), p ? (w.tabIndex = -1, Je(o) && (w.classList.add("selected"), e.selectedDateElem = w, e.config.mode === "range" && (U(w, "startRange", e.selectedDates[0] && ne(o, e.selectedDates[0], !0) === 0), U(w, "endRange", e.selectedDates[1] && ne(o, e.selectedDates[1], !0) === 0), n === "nextMonthDay" && w.classList.add("inRange")))) : w.classList.add("flatpickr-disabled"), e.config.mode === "range" && Nt(o) && !Je(o) && w.classList.add("inRange"), e.weekNumbers && e.config.showMonths === 1 && n !== "prevMonthDay" && l % 7 === 6 && e.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + e.config.getWeek(o) + "</span>"), z("onDayCreate", w), w;
  }
  function se(n) {
    n.focus(), e.config.mode === "range" && Oe(n);
  }
  function le(n) {
    for (var o = n > 0 ? 0 : e.config.showMonths - 1, r = n > 0 ? e.config.showMonths : -1, l = o; l != r; l += n)
      for (var p = e.daysContainer.children[l], w = n > 0 ? 0 : p.children.length - 1, T = n > 0 ? p.children.length : -1, y = w; y != T; y += n) {
        var H = p.children[y];
  ...
  function we(n, o) {
    for (var r = n.className.indexOf("Month") === -1 ? n.dateObj.getMonth() : e.currentMonth, l = o > 0 ? e.config.showMonths : -1, p = o > 0 ? 1 : -1, w = r - e.currentMonth; w != l; w += p)
      for (var T = e.daysContainer.children[w], y = r - e.currentMonth === w ? n.$i + o : o < 0 ? T.children.length - 1 : 0, H = T.children.length, b = y; b >= 0 && b < H && b != (o > 0 ? H : -1); b += p) {
        var E = T.children[b];
  ...
  function C(n, o) {
    var r = c(), l = Le(r || document.body), p = n !== void 0 ? n : l ? r : e.selectedDateElem !== void 0 && Le(e.selectedDateElem) ? e.selectedDateElem : e.todayDateElem !== void 0 && Le(e.todayDateElem) ? e.todayDateElem : le(o > 0 ? 1 : -1);
    p === void 0 ? e._input.focus() : l ? we(p, o) : se(p);
  }
  function B(n, o) {
    for (var r = (new Date(n, o, 1).getDay() - e.l10n.firstDayOfWeek + 7) % 7, l = e.utils.getDaysInMonth((o - 1 + 12) % 12, n), p = e.utils.getDaysInMonth(o, n), w = window.document.createDocumentFragment(), T = e.config.showMonths > 1, y = T ? "prevMonthDay hidden" : "prevMonthDay", H = T ? "nextMonthDay hidden" : "nextMonthDay", b = l + 1 - r, E = 0; b <= l; b++, E++)
      w.appendChild(J("flatpickr-day " + y, new Date(n, o - 1, b), b, E));
    for (b = 1; b <= p; b++, E++)
      w.appendChild(J("flatpickr-day", new Date(n, o, b), b, E));
    for (var Y = p + 1; Y <= 42 - r && (e.config.showMonths === 1 || E % 7 !== 0); Y++, E++)
      w.appendChild(J("flatpickr-day " + H, new Date(n, o + 1, Y % p), Y, E));
    var de = O("div", "dayContainer");
    return de.appendChild(w), de;
  }
  function $() {
    if (e.daysContainer !== void 0) {
      Pe(e.daysContainer), e.weekNumbers && Pe(e.weekNumbers);
      ...
      e.daysContainer.appendChild(n), e.days = e.daysContainer.firstChild, e.config.mode === "range" && e.selectedDates.length === 1 && Oe();
    }
  }
  function R() {
    if (!(e.config.showMonths > 1 || e.config.monthSelectorType !== "dropdown")) {
      ...
      for (var o = 0; o < 12; o++)
        if (n(o)) {
          ...
          r.value = new Date(e.currentYear, o).getMonth().toString(), r.textContent = We(o, e.config.shorthandCurrentMonth, e.l10n), r.tabIndex = -1, e.currentMonth === o && (r.selected = !0), e.monthsDropdownContainer.appendChild(r);
        }
    }
  }
  function he() {
    var n = O("div", "flatpickr-month"), o = window.document.createDocumentFragment(), r;
    e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? r = O("span", "cur-month") : (e.monthsDropdownContainer = O("select", "flatpickr-monthDropdown-months"), e.monthsDropdownContainer.setAttribute("aria-label", e.l10n.monthAriaLabel), D(e.monthsDropdownContainer, "change", function(T) {
      var y = te(T), H = parseInt(y.value, 10);
      e.changeMonth(H - e.currentMonth), z("onMonthChange");
    }), R(), r = e.monthsDropdownContainer);
    var l = ze("cur-year", { tabindex: "-1" }), p = l.getElementsByTagName("input")[0];
  ...
  function ge() {
    Pe(e.monthNav), e.monthNav.appendChild(e.prevMonthNav), e.config.showMonths && (e.yearElements = [], e.monthElements = []);
  ...
  function pe() {
    return e.monthNav = O("div", "flatpickr-months"), e.yearElements = [], e.monthElements = [], e.prevMonthNav = O("span", "flatpickr-prev-month"), e.prevMonthNav.innerHTML = e.config.prevArrow, e.nextMonthNav = O("span", "flatpickr-next-month"), e.nextMonthNav.innerHTML = e.config.nextArrow, ge(), Object.defineProperty(e, "_hidePrevMonthArrow", {
      get: function() {
    ...
    }), e.currentYearElement = e.yearElements[0], Ye(), e.monthNav;
  }
  function xe() {
    e.calendarContainer.classList.add("hasTime"), e.config.noCalendar && e.calendarContainer.classList.add("noCalendar");
    var n = ot(e.config);
    e.timeContainer = O("div", "flatpickr-time"), e.timeContainer.tabIndex = -1;
    var o = O("span", "flatpickr-time-separator", ":"), r = ze("flatpickr-hour", {
      "aria-label": e.l10n.hourAriaLabel
    });
    e.hourElement = r.getElementsByTagName("input")[0];
    var l = ze("flatpickr-minute", {
      "aria-label": e.l10n.minuteAriaLabel
    });
    if (e.minuteElement = l.getElementsByTagName("input")[0], e.hourElement.tabIndex = e.minuteElement.tabIndex = -1, e.hourElement.value = Z(e.latestSelectedDateObj ? e.latestSelectedDateObj.getHours() : e.config.time_24hr ? n.hours : i(n.hours)), e.minuteElement.value = Z(e.latestSelectedDateObj ? e.latestSelectedDateObj.getMinutes() : n.minutes), e.hourElement.setAttribute("step", e.config.hourIncrement.toString()), e.minuteElement.setAttribute("step", e.config.minuteIncrement.toString()), e.hourElement.setAttribute("min", e.config.time_24hr ? "0" : "1"), e.hourElement.setAttribute("max", e.config.time_24hr ? "23" : "12"), e.hourElement.setAttribute("maxlength", "2"), e.minuteElement.setAttribute("min", "0"), e.minuteElement.setAttribute("max", "59"), e.minuteElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(r), e.timeContainer.appendChild(o), e.timeContainer.appendChild(l), e.config.time_24hr && e.timeContainer.classList.add("time24hr"), e.config.enableSeconds) {
      e.timeContainer.classList.add("hasSeconds");
      var p = ze("flatpickr-second");
      e.secondElement = p.getElementsByTagName("input")[0], e.secondElement.value = Z(e.latestSelectedDateObj ? e.latestSelectedDateObj.getSeconds() : n.seconds), e.secondElement.setAttribute("step", e.minuteElement.getAttribute("step")), e.secondElement.setAttribute("min", "0"), e.secondElement.setAttribute("max", "59"), e.secondElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(O("span", "flatpickr-time-separator", ":")), e.timeContainer.appendChild(p);
    }
    return e.config.time_24hr || (e.amPM = O("span", "flatpickr-am-pm", e.l10n.amPM[re((e.latestSelectedDateObj ? e.hourElement.value : e.config.defaultHour) > 11)]), e.amPM.title = e.l10n.toggleTitle, e.amPM.tabIndex = -1, e.timeContainer.appendChild(e.amPM)), e.timeContainer;
  }
  function M() {
    e.weekdayContainer ? Pe(e.weekdayContainer) : e.weekdayContainer = O("div", "flatpickr-weekdays");
    for (var n = e.config.showMonths; n--; ) {
  ...
  function me(n, o) {
    ...
    r < 0 && e._hidePrevMonthArrow === !0 || r > 0 && e._hideNextMonthArrow === !0 || (e.currentMonth += r, (e.currentMonth < 0 || e.currentMonth > 11) && (e.currentYear += e.currentMonth > 11 ? 1 : -1, e.currentMonth = (e.currentMonth + 12) % 12, z("onYearChange"), R()), $(), z("onMonthChange"), Ye());
  }
  function Ct(n, o) {
    if (n === void 0 && (n = !0), o === void 0 && (o = !0), e.input.value = "", e.altInput !== void 0 && (e.altInput.value = ""), e.mobileInput !== void 0 && (e.mobileInput.value = ""), e.selectedDates = [], e.latestSelectedDateObj = void 0, o === !0 && (e.currentYear = e._initialDate.getFullYear(), e.currentMonth = e._initialDate.getMonth()), e.config.enableTime === !0) {
      var r = ot(e.config), l = r.hours, p = r.minutes, w = r.seconds;
      _(l, p, w);
    }
    e.redraw(), n && z("onChange");
  }
  function Dt() {
  ...
  function Ge(n) {
    if (e.isOpen && !e.config.inline) {
      var o = te(n), r = Te(o), l = o === e.input || o === e.altInput || e.element.contains(o) || n.path && n.path.indexOf && (~n.path.indexOf(e.input) || ~n.path.indexOf(e.altInput)), p = !l && !r && !Te(n.relatedTarget), w = !e.config.ignoredFocusElements.some(function(T) {
        return T.contains(o);
      });
  ...
  function Fe(n) {
    if (!(!n || e.config.minDate && n < e.config.minDate.getFullYear() || e.config.maxDate && n > e.config.maxDate.getFullYear())) {
      ...
      e.currentYear = o || e.currentYear, e.config.maxDate && e.currentYear === e.config.maxDate.getFullYear() ? e.currentMonth = Math.min(e.config.maxDate.getMonth(), e.currentMonth) : e.config.minDate && e.currentYear === e.config.minDate.getFullYear() && (e.currentMonth = Math.max(e.config.minDate.getMonth(), e.currentMonth)), r && (e.redraw(), z("onYearChange"), R());
    }
  }
  function ke(n, o) {
    var r;
    ...
    if (l === void 0)
      return !1;
    for (var p = !!e.config.enable, w = (r = e.config.enable) !== null && r !== void 0 ? r : e.config.disable, T = 0, y = void 0; T < w.length; T++) {
      if (y = w[T], typeof y == "function" && y(l))
        return p;
      if (y instanceof Date && l !== void 0 && y.getTime() === l.getTime())
        return p;
      if (typeof y == "string") {
        var H = e.parseDate(y, void 0, !0);
        return H && H.getTime() === l.getTime() ? p : !p;
  ...
  function Et(n) {
    var o = n.target === e._input, r = e._input.value.trimEnd() !== Ze();
    o && r && !(n.relatedTarget && Te(n.relatedTarget)) && e.setDate(e._input.value, !0, n.target === e.altInput ? e.config.altFormat : e.config.dateFormat);
  }
  function lt(n) {
      ...
      switch (n.keyCode) {
        ...
        case 39:
          if (!T && !r) {
            n.preventDefault();
            var y = c();
            if (e.daysContainer !== void 0 && (l === !1 || y && Le(y))) {
              var H = n.keyCode === 39 ? 1 : -1;
              n.ctrlKey ? (n.stopPropagation(), me(H), C(le(1), 0)) : C(void 0, H);
            }
        ...
        case 40:
          ...
          e.daysContainer && o.$i !== void 0 || o === e.input || o === e.altInput ? n.ctrlKey ? (n.stopPropagation(), Fe(e.currentYear - b), C(le(1), 0)) : T || C(void 0, b * 7) : o === e.currentYearElement ? Fe(e.currentYear - b) : e.config.enableTime && (!T && e.hourElement && e.hourElement.focus(), f(n), e._debouncedChange());
          break;
        case 9:
          if (T) {
            var E = [
    ...
    if (e.amPM !== void 0 && o === e.amPM)
      switch (n.key) {
        ...
        case e.l10n.amPM[0].charAt(0).toLowerCase():
          e.amPM.textContent = e.l10n.amPM[0], m(), ue();
          break;
        case e.l10n.amPM[1].charAt(0):
        case e.l10n.amPM[1].charAt(0).toLowerCase():
          e.amPM.textContent = e.l10n.amPM[1], m(), ue();
          break;
      }
    (r || Te(o)) && z("onKeyDown", n);
  }
  function Oe(n, o) {
    if (o === void 0 && (o = "flatpickr-day"), !(e.selectedDates.length !== 1 || n && (!n.classList.contains(o) || n.classList.contains("flatpickr-disabled")))) {
      for (var r = n ? n.dateObj.getTime() : e.days.firstElementChild.dateObj.getTime(), l = e.parseDate(e.selectedDates[0], void 0, !0).getTime(), p = Math.min(r, e.selectedDates[0].getTime()), w = Math.max(r, e.selectedDates[0].getTime()), T = !1, y = 0, H = 0, b = p; b < w; b += No.DAY)
        ke(new Date(b), !0) || (T = T || b > p && b < w, b < l && (!y || b > y) ? y = b : b > l && (!H || b < H) && (H = b));
      var E = Array.from(e.rContainer.querySelectorAll("*:nth-child(-n+" + e.config.showMonths + ") > ." + o));
      E.forEach(function(Y) {
        var de = Y.dateObj, ee = de.getTime(), He = y > 0 && ee < y || H > 0 && ee > H;
        if (He) {
        ...
        ["startRange", "inRange", "endRange", "notAllowed"].forEach(function(Me) {
          Y.classList.remove(Me);
        }), n !== void 0 && (n.classList.add(r <= e.selectedDates[0].getTime() ? "startRange" : "endRange"), l < r && ee === l ? Y.classList.add("startRange") : l > r && ee === l && Y.classList.add("endRange"), ee >= y && (H === 0 || ee <= H) && Oo(ee, l, r) && Y.classList.add("inRange"));
      });
    }
  }
  function St() {
  ...
  function jt(n, o) {
    if (o === void 0 && (o = e._positionElement), e.isMobile === !0) {
      ...
      return;
    var l = e.isOpen;
    e.isOpen = !0, l || (e.calendarContainer.classList.add("open"), e._input.classList.add("active"), z("onOpen"), Ie(o)), e.config.enableTime === !0 && e.config.noCalendar === !0 && e.config.allowInput === !1 && (n === void 0 || !e.timeContainer.contains(n.relatedTarget)) && setTimeout(function() {
  ...
  function dt(n) {
    return function(o) {
      ...
      r !== void 0 && (e[n === "min" ? "minDateHasTime" : "maxDateHasTime"] = r.getHours() > 0 || r.getMinutes() > 0 || r.getSeconds() > 0), e.selectedDates && (e.selectedDates = e.selectedDates.filter(function(p) {
        return ke(p);
      }), !e.selectedDates.length && n === "min" && j(r), ue()), e.daysContainer && (ft(), r !== void 0 ? e.currentYearElement[n] = r.getFullYear().toString() : e.currentYearElement.removeAttribute(n), e.currentYearElement.disabled = !!l && r !== void 0 && l.getFullYear() === r.getFullYear());
    };
  }
  function Tt() {
    var n = [
    ...
    Xe.filter(function(E) {
      ...
      e.config[E] = et(e.config[E] || []).map(h);
    }), e.isMobile = !e.config.disableMobile && !e.config.inline && e.config.mode === "single" && !e.config.disable.length && !e.config.enable && !e.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    for (var y = 0; y < e.config.plugins.length; y++) {
      var H = e.config.plugins[y](e) || {};
      for (var b in H)
        Xe.indexOf(b) > -1 ? e.config[b] = et(H[b]).map(h).concat(e.config[b]) : typeof o[b] > "u" && (e.config[b] = H[b]);
    }
    o.altInputClass || (e.config.altInputClass = ct().className + " " + e.config.altInputClass), z("onParseConfig");
  }
  function ct() {
    return e.config.wrap ? t.querySelector("[data-input]") : t;
  }
  function ut() {
    typeof e.config.locale != "object" && typeof K.l10ns[e.config.locale] > "u" && e.config.errorHandler(new Error("flatpickr: invalid locale " + e.config.locale)), e.l10n = G(G({}, K.l10ns.default), typeof e.config.locale == "object" ? e.config.locale : e.config.locale !== "default" ? K.l10ns[e.config.locale] : void 0), ye.D = "(" + e.l10n.weekdays.shorthand.join("|") + ")", ye.l = "(" + e.l10n.weekdays.longhand.join("|") + ")", ye.M = "(" + e.l10n.months.shorthand.join("|") + ")", ye.F = "(" + e.l10n.months.longhand.join("|") + ")", ye.K = "(" + e.l10n.amPM[0] + "|" + e.l10n.amPM[1] + "|" + e.l10n.amPM[0].toLowerCase() + "|" + e.l10n.amPM[1].toLowerCase() + ")";
    var n = G(G({}, a), JSON.parse(JSON.stringify(t.dataset || {})));
    n.time_24hr === void 0 && K.defaultConfig.time_24hr === void 0 && (e.config.time_24hr = e.l10n.time_24hr), e.formatDate = xt(e), e.parseDate = it({ config: e.config, l10n: e.l10n });
  }
  function Ie(n) {
    ...
    if (e.calendarContainer !== void 0) {
      ...
      }, 0), l = e.calendarContainer.offsetWidth, p = e.config.position.split(" "), w = p[0], T = p.length > 1 ? p[1] : null, y = o.getBoundingClientRect(), H = window.innerHeight - y.bottom, b = w === "above" || w !== "below" && H < r && y.top > r, E = window.pageYOffset + y.top + (b ? -r - 2 : o.offsetHeight + 2);
      if (U(e.calendarContainer, "arrowTop", !b), U(e.calendarContainer, "arrowBottom", b), !e.config.inline) {
        ...
        T === "center" ? (Y -= (l - y.width) / 2, de = !0) : T === "right" && (Y -= l - y.width, ee = !0), U(e.calendarContainer, "arrowLeft", !de && !ee), U(e.calendarContainer, "arrowCenter", de), U(e.calendarContainer, "arrowRight", ee);
        var He = window.document.body.offsetWidth - (window.pageXOffset + y.right), Me = Y + l > window.document.body.offsetWidth, zt = He + l > window.document.body.offsetWidth;
        if (U(e.calendarContainer, "rightMost", Me), !e.config.static)
          if (e.calendarContainer.style.top = E + "px", !Me)
            ...
            e.calendarContainer.style.left = "auto", e.calendarContainer.style.right = He + "px";
          else {
            var Qe = Ht();
            if (Qe === void 0)
              return;
            var Vt = window.document.body.offsetWidth, Rt = Math.max(0, Vt / 2 - l / 2), Wt = ".flatpickr-calendar.centerMost:before", Kt = ".flatpickr-calendar.centerMost:after", Gt = Qe.cssRules.length, qt = "{left:" + y.left + "px;right:auto;}";
            U(e.calendarContainer, "rightMost", !1), U(e.calendarContainer, "centerMost", !0), Qe.insertRule(Wt + "," + Kt + qt, Gt), e.calendarContainer.style.left = Rt + "px", e.calendarContainer.style.right = "auto";
          }
      }
    }
  }
  ...
  function ft() {
    e.config.noCalendar || e.isMobile || (R(), Ye(), $());
  }
  function qe() {
  ...
  function ht(n) {
    ...
    if (r !== void 0) {
      ...
      if (e.selectedDateElem = l, e.config.mode === "single")
        ...
        var T = Je(p);
        T ? e.selectedDates.splice(parseInt(T), 1) : e.selectedDates.push(p);
      ...
      if (m(), w) {
        ...
        e.currentYear = p.getFullYear(), e.currentMonth = p.getMonth(), y && (z("onYearChange"), R()), z("onMonthChange");
      }
      if (Ye(), $(), ue(), !w && e.config.mode !== "range" && e.config.showMonths === 1 ? se(l) : e.selectedDateElem !== void 0 && e.hourElement === void 0 && e.selectedDateElem && e.selectedDateElem.focus(), e.hourElement !== void 0 && e.hourElement !== void 0 && e.hourElement.focus(), e.config.closeOnSelect) {
        var H = e.config.mode === "single" && !e.config.enableTime, b = e.config.mode === "range" && e.selectedDates.length === 2 && !e.config.enableTime;
        (H || b) && qe();
      }
      A();
    }
  ...
  function Bt(n, o) {
    if (n !== null && typeof n == "object") {
      ...
      for (var r in n)
        Ne[r] !== void 0 && Ne[r].forEach(function(l) {
          return l();
        });
    } else
      e.config[n] = o, Ne[n] !== void 0 ? Ne[n].forEach(function(l) {
        return l();
      }) : Xe.indexOf(n) > -1 && (e.config[n] = et(o));
    e.redraw(), ue(!0);
  }
  function gt(n, o) {
    var r = [];
  ...
  function $t(n, o, r) {
    if (o === void 0 && (o = !1), r === void 0 && (r = e.config.dateFormat), n !== 0 && !n || n instanceof Array && n.length === 0)
      return e.clear(o);
    gt(n, r), e.latestSelectedDateObj = e.selectedDates[e.selectedDates.length - 1], e.redraw(), q(void 0, o), j(), e.selectedDates.length === 0 && e.clear(!1), ue(o), o && z("onChange");
  }
  function pt(n) {
  ...
  function Ot() {
    ...
    D(e.mobileInput, "change", function(o) {
      e.setDate(te(o).value, !1, e.mobileFormatStr), z("onChange"), z("onClose");
    });
  }
  function It(n) {
    if (e.isOpen === !0)
  ...
  function z(n, o) {
    if (e.config !== void 0) {
      ...
      n === "onChange" && (e.input.dispatchEvent(Ue("change")), e.input.dispatchEvent(Ue("input")));
    }
  }
  function Ue(n) {
  ...
  function Ye() {
    e.config.noCalendar || e.isMobile || !e.monthNav || (e.yearElements.forEach(function(n, o) {
      var r = new Date(e.currentYear, e.currentMonth, 1);
      r.setMonth(e.currentMonth + o), e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? e.monthElements[o].textContent = We(r.getMonth(), e.config.shorthandCurrentMonth, e.l10n) + " " : e.monthsDropdownContainer.value = r.getMonth().toString(), n.value = r.getFullYear().toString();
  ...
  function ue(n) {
    n === void 0 && (n = !0), e.mobileInput !== void 0 && e.mobileFormatStr && (e.mobileInput.value = e.latestSelectedDateObj !== void 0 ? e.formatDate(e.latestSelectedDateObj, e.mobileFormatStr) : ""), e.input.value = Ze(e.config.dateFormat), e.altInput !== void 0 && (e.altInput.value = Ze(e.config.altFormat)), n !== !1 && z("onValueUpdate");
  }
  function Yt(n) {
    var o = te(n), r = e.prevMonthNav.contains(o), l = e.nextMonthNav.contains(o);
    r || l ? me(r ? -1 : 1) : e.yearElements.indexOf(o) >= 0 ? o.select() : o.classList.contains("arrowUp") ? e.changeYear(e.currentYear + 1) : o.classList.contains("arrowDown") && e.changeYear(e.currentYear - 1);
  }
  function Pt(n) {
    n.preventDefault();
    var o = n.type === "keydown", r = te(n), l = r;
    e.amPM !== void 0 && r === e.amPM && (e.amPM.textContent = e.l10n.amPM[re(e.amPM.textContent === e.l10n.amPM[0])]);
    var p = parseFloat(l.getAttribute("min")), w = parseFloat(l.getAttribute("max")), T = parseFloat(l.getAttribute("step")), y = parseInt(l.value, 10), H = n.delta || (o ? n.which === 38 ? 1 : -1 : 0), b = y + T * H;
    if (typeof l.value < "u" && l.value.length === 2) {
      var E = l === e.hourElement, Y = l === e.minuteElement;
      b < p ? (b = w + b + re(!E) + (re(E) && re(!e.amPM)), Y && ie(void 0, -1, e.hourElement)) : b > w && (b = l === e.hourElement ? b - w - re(!e.amPM) : p, Y && ie(void 0, 1, e.hourElement)), e.amPM && E && (T === 1 ? b + y === 23 : Math.abs(b - y) > T) && (e.amPM.textContent = e.l10n.amPM[re(e.amPM.textContent === e.l10n.amPM[0])]), l.value = Z(b);
    }
  }
  return d(), e;
}
    ...
    var e = function() {
      return e = Object.assign || function(x) {
        for (var i, m = 1, j = arguments.length; m < j; m++) {
          i = arguments[m];
          for (var _ in i) Object.prototype.hasOwnProperty.call(i, _) && (x[_] = i[_]);
        }
        return x;
      ...
      return function(i) {
        ...
        function S() {
          if (m.monthsContainer) {
            ...
            for (var C = document.createDocumentFragment(), B = 0; B < 12; B++) {
              var $ = i.createDay("flatpickr-monthSelect-month", new Date(i.currentYear, B), 0, B);
              $.dateObj.getMonth() === (/* @__PURE__ */ new Date()).getMonth() && $.dateObj.getFullYear() === (/* @__PURE__ */ new Date()).getFullYear() && $.classList.add("today"), $.textContent = u(B, x.shorthand, i.l10n), $.addEventListener("click", q), C.appendChild($);
            }
        ...
        function D() {
          i._bind(i.prevMonthNav, "click", function(C) {
            C.preventDefault(), C.stopPropagation(), i.changeYear(i.currentYear - 1), X(), S();
        ...
        function A() {
          if (i.rContainer && i.selectedDates.length) {
            ...
            var $ = i.selectedDates[0].getMonth(), R = i.rContainer.querySelector(".flatpickr-monthSelect-month:nth-child(" + ($ + 1) + ")");
        ...
        function X() {
          ...
          if (C && (C = new Date(C), C.setFullYear(i.currentYear), i.config.minDate && C < i.config.minDate && (C = i.config.minDate), i.config.maxDate && C > i.config.maxDate && (C = i.config.maxDate), i.currentYear = C.getFullYear()), i.currentYearElement.value = String(i.currentYear), i.rContainer) {
            ...
            B.forEach(function($) {
              $.dateObj.setFullYear(i.currentYear), i.config.minDate && $.dateObj < i.config.minDate || i.config.maxDate && $.dateObj > i.config.maxDate ? $.classList.add("flatpickr-disabled") : $.classList.remove("flatpickr-disabled");
            });
          }
          A();
        }
        function q(C) {
          ...
          if (B instanceof Element && !B.classList.contains("flatpickr-disabled") && !B.classList.contains("notAllowed") && (oe(B.dateObj), i.config.closeOnSelect)) {
            var $ = i.config.mode === "single", R = i.config.mode === "range" && i.selectedDates.length === 2;
            ($ || R) && i.close();
          }
        }
        function oe(C) {
          var B = new Date(i.currentYear, C.getMonth(), C.getDate()), $ = [];
          switch (i.config.mode) {
            ...
            case "multiple":
              ...
              break;
            case "range":
              i.selectedDates.length === 2 ? $ = [B] : ($ = i.selectedDates.concat([B]), $.sort(function(R, he) {
                return R.getTime() - he.getTime();
              }));
              break;
          }
          i.setDate($, !0), A();
        ...
        function ve(C, B, $, R) {
          var he = ie[R.keyCode] !== void 0;
          if (!(!he && R.keyCode !== 13) && !(!i.rContainer || !m.monthsContainer)) {
            var ge = i.rContainer.querySelector(".flatpickr-monthSelect-month.selected"), pe = Array.prototype.indexOf.call(m.monthsContainer.children, document.activeElement);
            if (pe === -1) {
              var xe = ge || m.monthsContainer.firstElementChild;
              xe.focus(), pe = xe.$i;
            }
            he ? m.monthsContainer.children[(12 + pe + ie[R.keyCode]) % 12].focus() : R.keyCode === 13 && m.monthsContainer.contains(document.activeElement) && oe(document.activeElement.dateObj);
          }
        }
        function J() {
          var C;
        ...
        return {
          ...
          onReady: [
            ...
            A,
            function() {
              i.config.onClose.push(J), i.loadedPlugins.push("monthSelect");
            }
          ],
          onDestroy: [
            le,
...
const Wo = /* @__PURE__ */ Vo(Ro), Ko = { class: "relative" }, Go = ["placeholder", "disabled", "readonly"], qo = {
...
}, Uo = { class: "flex items-center justify-between mb-2" }, Jo = { class: "text-xs opacity-70" }, Zo = { class: "grid grid-cols-4 gap-2" }, Qo = ["onClick"], xa = /* @__PURE__ */ V({
  ...
  emits: ["update:modelValue"],
  setup(t, { emit: a }) {
    const e = t, u = a, d = Q(null), c = Q(!1), h = Q((/* @__PURE__ */ new Date()).getFullYear() - 6);
    let s = null;
    const f = F(() => e.picker === "month" ? e.dateFormat || "Y-m" : e.picker === "year" ? e.dateFormat || "Y" : e.dateFormat ? e.dateFormat : e.noCalendar ? "H:i" : e.enableTime ? "Y-m-d H:i" : "Y-m-d"), x = () => {
      var S, D;
      if (d.value) {
        ...
        (D = s == null ? void 0 : s.destroy) == null || D.call(s), s = K(d.value, {
          mode: e.mode,
          ...
          onChange: (A) => {
            if (e.mode === "range") {
              ...
              const X = A[0] ? s.formatDate(A[0], f.value) : "";
              u("update:modelValue", X);
            }
          }
        });
    ...
    const m = F(
      () => Array.from({ length: 12 }, (S, D) => h.value + D)
    ), j = (S) => {
      u("update:modelValue", S.toString()), c.value = !1;
    }, _ = (S) => {
      if (!c.value) return;
      const D = S.target;
      if (d.value && D && d.value.contains(D)) return;
      const A = document.querySelector(".mitreka-year-grid");
      A && D && A.contains(D) || (c.value = !1);
    };
    return at(() => document.addEventListener("click", _)), rt(() => document.removeEventListener("click", _)), (S, D) => (v(), k("div", Ko, [
      g("input", {
        ref_key: "inputEl",
        ref: d,
      ...
      t.picker === "year-grid" && c.value ? (v(), k("div", qo, [
        g("div", Uo, [
          g("button", {
            ...
            type: "button",
            onClick: D[0] || (D[0] = (A) => h.value -= 12)
          }, " Prev "),
          g("div", Jo, I(h.value) + " - " + I(h.value + 11), 1),
          g("button", {
            class: "btn btn-ghost btn-xs",
            type: "button",
            onClick: D[1] || (D[1] = (A) => h.value += 12)
          }, " Next ")
        ]),
        g("div", Zo, [
          (v(!0), k(fe, null, Se(m.value, (A) => (v(), k("button", {
            key: A,
            class: L(["btn btn-ghost btn-xs", { "btn-primary": t.modelValue === A.toString() }]),
            type: "button",
            onClick: (X) => j(A)
          }, I(A), 11, Qo))), 128))
        ])
  ...
  emits: ["grid-ready"],
  setup(t, { emit: a }) {
    const e = t, u = a, d = an(), c = Q(null), h = Q(null), s = Q(13), f = Q(!1);
    let x = null, i = null;
    const m = ["modelUpdated", "paginationChanged", "filterChanged", "rowDataUpdated"], j = [], _ = Q("normal"), S = F(() => [
      "w-full",
      _.value === "autoHeight" ? "h-auto" : "h-full"
    ]), D = () => {
      const M = document.documentElement, P = M.classList.contains("dark"), ae = (M.getAttribute("data-theme") || "").toLowerCase() === "mitrekadark";
      f.value = P || ae;
    }, A = F(() => e.themeMode === "dark" ? !0 : e.themeMode === "light" ? !1 : f.value), X = F(() => A.value ? "ag-theme-quartz-dark" : "ag-theme-quartz"), q = F(() => e.density === "compact" ? "agx-compact" : e.density === "spacious" ? "agx-spacious" : ""), oe = F(() => ["agx", X.value, q.value, d.class]), ie = F(() => [{ "--ag-odd-row-background-color": e.striped ? A.value ? "#0d1a33" : "#F3F4F6" : "transparent" }, d.style]), ve = F(() => {
      const { class: M, style: P, onGridReady: ae, ...me } = d;
      return me;
    }), J = (M) => typeof M == "number" && Number.isFinite(M) ? M : void 0, se = F(() => {
      ...
      const me = J(d[M === "headerHeight" ? "header-height" : "group-header-height"]);
      return typeof me == "number" ? me : J(se.value[M]);
    }, we = () => {
      const M = d.domLayout;
      if (typeof M == "string" && M.length > 0) return M;
      const P = d["dom-layout"];
      if (typeof P == "string" && P.length > 0) return P;
      const ae = se.value.domLayout;
      ...
      const M = we();
      if (M) {
        _.value = M, h.value.setGridOption("domLayout", M);
        return;
      }
      const P = e.autoHeightWhenFewRows && C() < B() ? "autoHeight" : "normal";
      _.value = P, h.value.setGridOption("domLayout", P);
    }, R = () => {
      var M;
      for (; j.length > 0; )
        (M = j.pop()) == null || M();
      ...
      m.forEach((P) => {
        h.value.addEventListener(P, M), j.push(() => {
          var ae;
          (ae = h.value) == null || ae.removeEventListener(P, M);
        });
      });
    }, ge = () => {
      if (!e.autoHeaderHeight || !h.value) return;
      const M = le("headerHeight") ?? cn(e.density), P = le("groupHeaderHeight") ?? un(e.density);
      ...
      h.value = M.api, s.value = hn(c.value), he(), ge(), $(), pe(), u("grid-ready", M);
    };
    return ce(
      () => e.density,
      () => {
        var M;
        ge(), pe(), (M = h.value) == null || M.refreshCells({ force: !0 });
      }
    ), ce(
      () => [
        d.headerHeight,
      ...
      D(), e.autoObserveTheme && (x = new MutationObserver(D), x.observe(document.documentElement, {
        attributes: !0,
        attributeFilter: ["class", "data-theme"]
      })), e.pinnedShadows && c.value && (i = dn(c.value));
    }), rt(() => {
      x == null || x.disconnect(), R(), i == null || i();
    }), (M, P) => (v(), k("div", {
      ref_key: "hostRef",
      ref: c,
      class: L(S.value)
    }, [
      Ee(je(gn), rn(ve.value, {
        class: oe.value,
        theme: "legacy",
        style: ie.value,
        onGridReady: xe
