import { defineComponent as R, createElementBlock as k, openBlock as v, normalizeClass as F, createCommentVNode as N, renderSlot as W, createElementVNode as g, ref as ee, watch as ce, withKeys as _e, withModifiers as Be, createBlock as qe, Teleport as dt, createVNode as Ee, Transition as We, withCtx as Ke, toDisplayString as I, provide as Zt, inject as Qt, computed as $, normalizeStyle as ve, createTextVNode as yt, Fragment as pe, renderList as Se, unref as He, useSlots as Xt, resolveDynamicComponent as en, reactive as tn, withDirectives as nn, vModelText as on, onMounted as it, onBeforeUnmount as st, useAttrs as an, mergeProps as rn } from "vue";
import { a as sn, u as ln, c as dn, e as cn, f as un, d as fn, r as hn } from "./useAgGridRowHeight-DvcPZ1ET.js";
...
const pn = ["disabled"], mn = {
  ...
  setup(t, { emit: a }) {
    ...
    return (s, h) => (v(), k("button", {
      class: F(["btn", d[t.size], c()]),
      disabled: t.disabled || t.loading,
      onClick: f
    }, [
      t.loading ? (v(), k("span", mn, [...h[0] || (h[0] = [
        g("svg", {
          class: "w-4 h-4",
          fill: "none",
          viewBox: "0 0 24 24"
  ...
  setup(t, { expose: a, emit: e }) {
    const u = t, d = e, c = ee(u.modelValue !== void 0 ? u.modelValue : u.defaultOpen);
    ce(() => u.modelValue, (s) => {
      s !== void 0 && (c.value = s);
    });
    function f() {
    ...
    return a({ isOpen: c, toggle: f }), (s, h) => (v(), k("section", {
      ...
      s.$slots.title ? (v(), k("header", {
        ...
        onClick: f,
        onKeydown: [
          h[0] || (h[0] = _e((x) => t.collapsible && f(), ["enter"])),
          h[1] || (h[1] = _e(Be((x) => t.collapsible && f(), ["prevent"]), ["space"]))
        ]
      }, [
        g("div", wn, [
          W(s.$slots, "title")
        ...
        t.collapsible ? (v(), k("svg", {
          key: 0,
          class: F(["card-collapse-icon", { "is-open": c.value }]),
      ...
      t.collapsible ? (v(), k("div", {
        key: 1,
        class: F(["card-body-wrapper", { "is-open": c.value }])
      }, [
        g("div", kn, [
          W(s.$slots, "default")
        ])
  ...
  setup(t, { expose: a, emit: e }) {
    ...
    return a({ isOpen: c, toggle: f }), (s, h) => (v(), k("div", {
      class: F([
        "collapse",
        `collapse-${t.variant}`,
        { "is-open": c.value }
  ...
  setup(t, { expose: a, emit: e }) {
    const u = t, d = e, c = ee(/* @__PURE__ */ new Set());
    ce(() => u.modelValue, (h) => {
      h === null ? c.value = /* @__PURE__ */ new Set() : Array.isArray(h) ? c.value = new Set(h) : c.value = /* @__PURE__ */ new Set([h]);
    }, { immediate: !0 });
    function f(h) {
      const x = new Set(c.value);
      x.has(h) ? x.delete(h) : (u.multiple || x.clear(), x.add(h)), c.value = x, u.multiple ? d("update:modelValue", Array.from(x)) : d("update:modelValue", x.size > 0 ? Array.from(x)[0] : null);
    }
    function s(h) {
      return c.value.has(h);
    }
    return Zt("accordion", {
      toggleItem: f,
      isItemOpen: s
    }), a({ openItems: c, toggleItem: f }), (h, x) => (v(), k("div", {
      class: F(["accordion", `accordion-${t.variant}`])
    }, [
      W(h.$slots, "default")
    ], 2));
  }
}), Sn = ["aria-expanded", "aria-disabled", "onKeydown"], Hn = { class: "accordion-title" }, jn = { class: "accordion-content" }, Tn = { class: "accordion-content-inner" }, An = { class: "accordion-body" }, la = /* @__PURE__ */ R({
  ...
  setup(t) {
    const a = t, e = Qt("accordion"), u = $(() => (e == null ? void 0 : e.isItemOpen(a.id)) ?? !1);
    function d() {
...
}), Bn = { class: "loading-logo-wrapper" }, $n = { class: "dots-container" }, Fn = ["width", "height"], Ln = {
  key: 0,
  class: "loading-text"
}, On = /* @__PURE__ */ R({
  __name: "LoadingLogo",
  ...
  setup(t) {
    const a = t, e = $(() => Math.round(a.size * (8 / 60)));
  ...
  setup(t) {
    const a = sn(), e = $(() => {
      ...
      return ((m = {
        ...
        solid: c,
        outline: f
      }[x]) == null ? void 0 : m[h]) || d[h] || "toast-default";
    };
    return (h, x) => (v(), qe(dt, { to: "body" }, [
      g("div", {
        class: F(["toast-container", e.value])
      }, [
        (v(!0), k(pe, null, Se(He(a).toasts.value, (i) => (v(), k("div", {
          key: i.id,
  ...
  setup(t) {
    ...
    }, f = $(() => `tooltip-pos-${a.position}`), s = $(() => `tooltip-arrow-${a.position}`), h = $(() => `tooltip-variant-${a.variant}`);
    return (x, i) => (v(), k("span", {
      class: "tooltip-root",
      onMouseenter: d,
      onMouseleave: c,
  ...
  setup(t) {
    const a = t, e = ee(!1), u = $(() => a.src && !e.value), d = $(() => a.fallback ? a.fallback.slice(0, 2).toUpperCase() : a.alt && a.alt !== "Avatar" ? a.alt.split(" ").map((m) => m[0]).slice(0, 2).join("").toUpperCase() : "?"), c = $(() => `avatar-size-${a.size}`), f = $(() => `avatar-color-${a.color}`), s = $(() => a.status ? `avatar-status-${a.status}` : ""), h = $(() => `avatar-status-size-${a.size}`), x = $(() => a.square ? "avatar-square" : "avatar-round"), i = () => {
      e.value = !0;
    };
    return (m, H) => (v(), k("span", Jn, [
      u.value ? (v(), k("img", {
        key: 0,
        src: t.src,
        alt: t.alt,
        class: F(["avatar-img", [c.value, x.value]]),
        onError: i
      }, null, 42, Zn)) : (v(), k("span", {
        key: 1,
        class: F(["avatar-fallback", [c.value, f.value, x.value]])
      }, I(d.value), 3)),
      t.status ? (v(), k("span", {
        key: 2,
  ...
  setup(t) {
    const a = t, e = Xt(), u = $(() => {
      ...
      return s ? s.length : 0;
    }), d = $(() => u.value <= a.max ? 0 : u.value - a.max), c = $(() => `avatar-size-${a.size}`), f = $(() => `avatar-group-space-${a.size}`);
    return (s, h) => (v(), k("div", {
      class: F(["avatar-group", f.value])
    }, [
      (v(!0), k(pe, null, Se(t.max, (x, i) => {
        var m, H;
        return v(), k(pe, { key: i }, [
          i < u.value ? (v(), qe(en((H = (m = He(e)).default) == null ? void 0 : H.call(m)[i]), { key: 0 })) : N("", !0)
        ], 64);
      }), 128)),
      d.value > 0 ? (v(), k("span", {
        key: 0,
        class: F(["avatar-group-count", c.value])
      }, " +" + I(d.value), 3)) : N("", !0)
    ], 2));
  }
}), Qn = {
  ...
  setup(t) {
    ...
    return (u, d) => t.items.length ? (v(), k("nav", Qn, [
      g("ol", Xn, [
        ...
        (v(!0), k(pe, null, Se(t.items, (c, f) => (v(), k("li", {
          key: f,
          class: "breadcrumbs-item"
        }, [
          d[0] || (d[0] = g("span", { class: "breadcrumbs-sep" }, "/", -1)),
          e(f) ? (v(), k("span", ro, I(c.label), 1)) : (v(), k("span", no, [
            c.href ? (v(), k("a", {
              key: 0,
              href: c.href,
              class: "breadcrumbs-link"
  ...
  setup(t) {
    const { mode: a, setTheme: e, toggleTheme: u } = ln("light"), d = $(
      () => a.value === "dark" ? "mitrekadark" : "mitrekalight"
    ), c = (f) => {
      e(f === "mitrekadark" ? "dark" : "light");
    };
    return (f, s) => (v(), k("div", mo, [
      g("button", {
      ...
      g("select", {
        ...
        value: d.value,
        onChange: s[1] || (s[1] = (h) => c(h.target.value))
      }, [...s[2] || (s[2] = [
  ...
  key: 0,
  class: "sidebar-label"
}, _o = ["title", "onClick"], Eo = { class: "sidebar-icon" }, So = { class: "sidebar-icon-text" }, Ho = {
  key: 0,
  class: "sidebar-label"
}, jo = ["href", "title", "onClick"], To = { class: "sidebar-icon" }, Ao = { class: "sidebar-icon-text" }, Bo = {
  key: 0,
  class: "sidebar-label"
}, ka = /* @__PURE__ */ R({
  __name: "Sidebar",
  ...
  setup(t, { emit: a }) {
    const e = t, u = a, d = ee(""), c = tn({});
    e.defaultOpenIds.forEach((m) => {
      c[m] = !0;
    });
    const f = (m) => !e.activeHref || !m.href ? !1 : m.exact ? e.activeHref === m.href : e.activeHref.startsWith(m.href), s = (m) => {
      var S;
      if (!m.children) return !1;
      if (d.value.trim()) return !0;
      const H = c[m.id], D = ((S = m.children) == null ? void 0 : S.some(f)) ?? !1;
      return H === void 0 && D && (c[m.id] = !0), c[m.id] ?? D;
    }, h = (m) => {
      const H = !s(m);
      c[m.id] = H, u("toggle", m.id, H);
    }, x = $(() => {
      const m = d.value.toLowerCase().trim();
      return m ? e.items.map((H) => {
        if (H.children) {
          const D = H.children.filter(
            (S) => S.label.toLowerCase().includes(m)
          );
          return H.label.toLowerCase().includes(m) ? H : D.length > 0 ? { ...H, children: D } : null;
        }
        return H.label.toLowerCase().includes(m) ? H : null;
      }).filter(Boolean) : e.items;
    }), i = (m) => {
      u("navigate", m), d.value = "";
    };
    return (m, H) => (v(), k("aside", {
      ...
      t.showSearch && !t.collapsed ? (v(), k("div", ko, [
        ...
        d.value ? (v(), k("button", {
          ...
          onClick: H[1] || (H[1] = (D) => d.value = "")
        }, " × ")) : N("", !0)
      ])) : N("", !0),
      g("nav", yo, [
        (v(!0), k(pe, null, Se(x.value, (D) => (v(), k(pe, {
          key: D.id
        }, [
          D.children ? (v(), k(pe, { key: 1 }, [
            g("button", {
              class: F(["sidebar-item sidebar-group", s(D) ? "is-open" : ""]),
              ...
              t.collapsed ? N("", !0) : (v(), k("span", Ho, I(D.label), 1)),
              t.collapsed ? N("", !0) : (v(), k("span", {
                key: 1,
                class: F(["sidebar-caret", s(D) ? "rotate" : ""])
              }, "›", 2))
            ], 10, _o),
            s(D) ? (v(), k("div", {
              key: 0,
              ...
              (v(!0), k(pe, null, Se(D.children, (S) => (v(), k("a", {
                key: S.id,
                class: F(["sidebar-item sidebar-child", f(S) ? "is-active" : ""]),
                href: S.href || "#",
            ...
            key: 0,
            class: F(["sidebar-item", f(D) ? "is-active" : ""]),
            href: D.href || "#",
            title: t.collapsed ? D.label : void 0,
  ...
  setup(t) {
    const a = t, e = $(() => a.class || "w-5 h-5"), u = $(() => xt[a.name]), d = $(
      () => u.value ? u.value.replace("<svg", `<svg class='${e.value}'`) : ""
    );
    return (c, f) => u.value ? (v(), k("span", {
      key: 0,
      innerHTML: d.value,
      class: F(e.value)
    }, null, 10, $o)) : (v(), k("span", Fo, "?"));
  }
});
var tt = [
  "onChange",
...
var ot = function() {
  ...
  K: function(t, a, e) {
    t.setHours(t.getHours() % 12 + 12 * se(new RegExp(e.amPM[1], "i").test(a)));
  },
  M: function(t, a, e) {
  ...
  K: function(t, a) {
    return a.amPM[se(t.getHours() > 11)];
  },
  M: function(t, a) {
    return Ge(t.getMonth(), !0, a);
  },
  S: function(t) {
  ...
  var a = t.config, e = a === void 0 ? Ce : a, u = t.l10n, d = u === void 0 ? $e : u, c = t.isMobile, f = c === void 0 ? !1 : c;
  return function(s, h, x) {
    var i = x || d;
    return e.formatDate !== void 0 && !f ? e.formatDate(s, h, i) : h.split("").map(function(m, H, D) {
      return Ae[m] && D[H - 1] !== "\\" ? Ae[m](s, i, e) : m !== "\\" ? m : "";
    }).join("");
  };
}, lt = function(t) {
  var a = t.config, e = a === void 0 ? Ce : a, u = t.l10n, d = u === void 0 ? $e : u;
  return function(c, f, s, h) {
    if (!(c !== 0 && !c)) {
      var x = h || d, i, m = c;
      if (c instanceof Date)
        ...
        var H = f || (e || Ce).dateFormat, D = String(c).trim();
        if (D === "today")
          ...
          for (var S = void 0, _ = [], A = 0, Q = 0, J = ""; A < H.length; A++) {
            var ae = H[A], le = ae === "\\", we = H[A - 1] === "\\" || le;
            if (ye[ae] && !we) {
              J += ye[ae];
              var re = new RegExp(J).exec(c);
              re && (S = !0) && _[ae !== "Y" ? "push" : "unshift"]({
                fn: Lo[ae],
                val: re[++Q]
              });
            } else le || (J += ".");
          }
          i = !e || !e.noCalendar ? new Date((/* @__PURE__ */ new Date()).getFullYear(), 0, 1, 0, 0, 0, 0) : new Date((/* @__PURE__ */ new Date()).setHours(0, 0, 0, 0)), _.forEach(function(ie) {
            var de = ie.fn, me = ie.val;
            return i = de(i, me, x) || i;
          }), i = S ? i : void 0;
        }
      }
...
function rt(t) {
  ...
  if (t.minDate !== void 0) {
    var d = t.minDate.getHours(), c = t.minDate.getMinutes(), f = t.minDate.getSeconds();
    a < d && (a = d), a === d && e < c && (e = c), a === d && e === c && u < f && (u = t.minDate.getSeconds());
  }
  if (t.maxDate !== void 0) {
...
var U = function() {
  ...
  for (var u = Array(t), d = 0, a = 0; a < e; a++)
    for (var c = arguments[a], f = 0, s = c.length; f < s; f++, d++)
      u[d] = c[f];
  return u;
}, Yo = 300;
function Po(t, a) {
  var e = {
    config: U(U({}, Ce), G.defaultConfig),
    l10n: $e
  };
  e.parseDate = lt({ config: e.config, l10n: e.l10n }), e._handlers = [], e.pluginElements = [], e.loadedPlugins = [], e._bind = _, e._setHoursFromDate = H, e._positionCalendar = Ye, e.changeMonth = q, e.changeYear = Oe, e.clear = K, e.close = Le, e.onMouseOver = Ne, e._createElement = O, e.createDay = re, e.destroy = _t, e.isEnabled = be, e.jumpToDate = J, e.updateValue = ge, e.open = Ht, e.redraw = gt, e.set = Bt, e.setDate = $t, e.toggle = It;
  function u() {
    e.utils = {
  ...
  function d() {
    e.element = e.input = t, e.isOpen = !1, jt(), ht(), Lt(), Ft(), u(), e.isMobile || we(), Q(), (e.selectedDates.length || e.config.noCalendar) && (e.config.enableTime && H(e.config.noCalendar ? e.latestSelectedDateObj : void 0), ge(!1)), s();
    var n = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
    !e.isMobile && n && Ye(), V("onReady");
  }
  function c() {
    var n;
  ...
  function h(n) {
    if (e.selectedDates.length === 0) {
      var o = e.config.minDate === void 0 || oe(/* @__PURE__ */ new Date(), e.config.minDate) >= 0 ? /* @__PURE__ */ new Date() : new Date(e.config.minDate.getTime()), r = rt(e.config);
    ...
    m(), ge(), e._input.value !== l && e._debouncedChange();
  }
  function x(n, o) {
    return n % 12 + 12 * se(o === e.l10n.amPM[1]);
  }
  function i(n) {
    switch (n % 24) {
      case 0:
  ...
  function m() {
    if (!(e.hourElement === void 0 || e.minuteElement === void 0)) {
      ...
      var l = e.config.minTime !== void 0 || e.config.minDate && e.minDateHasTime && e.latestSelectedDateObj && oe(e.latestSelectedDateObj, e.config.minDate, !0) === 0, p = e.config.maxTime !== void 0 || e.config.maxDate && e.maxDateHasTime && e.latestSelectedDateObj && oe(e.latestSelectedDateObj, e.config.maxDate, !0) === 0;
      if (e.config.maxTime !== void 0 && e.config.minTime !== void 0 && e.config.minTime > e.config.maxTime) {
        var w = at(e.config.minTime.getHours(), e.config.minTime.getMinutes(), e.config.minTime.getSeconds()), j = at(e.config.maxTime.getHours(), e.config.maxTime.getMinutes(), e.config.maxTime.getSeconds()), y = at(n, o, r);
        if (y > j && y < w) {
          var T = Io(w);
          n = T[0], o = T[1], r = T[2];
        }
  ...
  function D(n, o, r) {
    e.latestSelectedDateObj !== void 0 && e.latestSelectedDateObj.setHours(n % 24, o, r || 0, 0), !(!e.hourElement || !e.minuteElement || e.isMobile) && (e.hourElement.value = X(e.config.time_24hr ? n : (12 + n) % 12 + 12 * se(n % 12 === 0)), e.minuteElement.value = X(o), e.amPM !== void 0 && (e.amPM.textContent = e.l10n.amPM[se(n >= 12)]), e.secondElement !== void 0 && (e.secondElement.value = X(r)));
  }
  function S(n) {
    var o = ne(n), r = parseInt(o.value) + (n.delta || 0);
  ...
  function Q() {
    ...
    var n = kt(St, 50);
    if (e._debouncedChange = kt(A, Yo), e.daysContainer && !/iPhone|iPad|iPod/i.test(navigator.userAgent) && _(e.daysContainer, "mouseover", function(r) {
      e.config.mode === "range" && Ne(ne(r));
    }), _(e._input, "keydown", ct), e.calendarContainer !== void 0 && _(e.calendarContainer, "keydown", ct), !e.config.inline && !e.config.static && _(window, "resize", n), window.ontouchstart !== void 0 ? _(window.document, "touchstart", Ue) : _(window.document, "mousedown", Ue), _(window.document, "focus", Ue, { capture: !0 }), e.config.clickOpens === !0 && (_(e._input, "focus", e.open), _(e._input, "click", e.open)), e.daysContainer !== void 0 && (_(e.monthNav, "click", Yt), _(e.monthNav, ["keyup", "increment"], S), _(e.daysContainer, "click", pt)), e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0) {
      var o = function(r) {
        return ne(r).select();
      };
      _(e.timeContainer, ["increment"], h), _(e.timeContainer, "blur", h, { capture: !0 }), _(e.timeContainer, "click", ae), _([e.hourElement, e.minuteElement], ["focus", "click"], o), e.secondElement !== void 0 && _(e.secondElement, "focus", function() {
  ...
  function ae(n) {
    var o = ne(n);
    ~o.className.indexOf("arrow") && le(n, o.classList.contains("arrowUp") ? 1 : -1);
  }
  function le(n, o, r) {
    var l = n && ne(n), p = r || l && l.parentNode && l.parentNode.firstChild, w = Ze("increment");
  ...
  function we() {
    ...
    if (e.calendarContainer = O("div", "flatpickr-calendar"), e.calendarContainer.tabIndex = -1, !e.config.noCalendar) {
      if (n.appendChild(he()), e.innerContainer = O("div", "flatpickr-innerContainer"), e.config.weekNumbers) {
        var o = Y(), r = o.weekWrapper, l = o.weekNumbers;
        e.innerContainer.appendChild(r), e.weekNumbers = l, e.weekWrapper = r;
      }
      e.rContainer = O("div", "flatpickr-rContainer"), e.rContainer.appendChild(Fe()), e.daysContainer || (e.daysContainer = O("div", "flatpickr-days"), e.daysContainer.tabIndex = -1), L(), e.rContainer.appendChild(e.daysContainer), e.innerContainer.appendChild(e.rContainer), n.appendChild(e.innerContainer);
    }
    e.config.enableTime && n.appendChild(ke()), Z(e.calendarContainer, "rangeMode", e.config.mode === "range"), Z(e.calendarContainer, "animate", e.config.animate === !0), Z(e.calendarContainer, "multiMonth", e.config.showMonths > 1), e.calendarContainer.appendChild(n);
  ...
  function re(n, o, r, l) {
    var p = be(o, !0), w = O("span", n, o.getDate().toString());
    return w.dateObj = o, w.$i = l, w.setAttribute("aria-label", e.formatDate(o, e.config.ariaDateFormat)), n.indexOf("hidden") === -1 && oe(o, e.now) === 0 && (e.todayDateElem = w, w.classList.add("today"), w.setAttribute("aria-current", "date")), p ? (w.tabIndex = -1, Qe(o) && (w.classList.add("selected"), e.selectedDateElem = w, e.config.mode === "range" && (Z(w, "startRange", e.selectedDates[0] && oe(o, e.selectedDates[0], !0) === 0), Z(w, "endRange", e.selectedDates[1] && oe(o, e.selectedDates[1], !0) === 0), n === "nextMonthDay" && w.classList.add("inRange")))) : w.classList.add("flatpickr-disabled"), e.config.mode === "range" && Nt(o) && !Qe(o) && w.classList.add("inRange"), e.weekNumbers && e.config.showMonths === 1 && n !== "prevMonthDay" && l % 7 === 6 && e.weekNumbers.insertAdjacentHTML("beforeend", "<span class='flatpickr-day'>" + e.config.getWeek(o) + "</span>"), V("onDayCreate", w), w;
  }
  function ie(n) {
    n.focus(), e.config.mode === "range" && Ne(n);
  }
  function de(n) {
    for (var o = n > 0 ? 0 : e.config.showMonths - 1, r = n > 0 ? e.config.showMonths : -1, l = o; l != r; l += n)
      for (var p = e.daysContainer.children[l], w = n > 0 ? 0 : p.children.length - 1, j = n > 0 ? p.children.length : -1, y = w; y != j; y += n) {
        var T = p.children[y];
        if (T.className.indexOf("hidden") === -1 && be(T.dateObj))
          return T;
      }
  }
  function me(n, o) {
    for (var r = n.className.indexOf("Month") === -1 ? n.dateObj.getMonth() : e.currentMonth, l = o > 0 ? e.config.showMonths : -1, p = o > 0 ? 1 : -1, w = r - e.currentMonth; w != l; w += p)
      for (var j = e.daysContainer.children[w], y = r - e.currentMonth === w ? n.$i + o : o < 0 ? j.children.length - 1 : 0, T = j.children.length, b = y; b >= 0 && b < T && b != (o > 0 ? T : -1); b += p) {
        var E = j.children[b];
        if (E.className.indexOf("hidden") === -1 && be(E.dateObj) && Math.abs(n.$i - b) >= Math.abs(o))
          return ie(E);
      }
    e.changeMonth(p), M(de(p), 0);
  }
  function M(n, o) {
    var r = c(), l = Ie(r || document.body), p = n !== void 0 ? n : l ? r : e.selectedDateElem !== void 0 && Ie(e.selectedDateElem) ? e.selectedDateElem : e.todayDateElem !== void 0 && Ie(e.todayDateElem) ? e.todayDateElem : de(o > 0 ? 1 : -1);
    p === void 0 ? e._input.focus() : l ? me(p, o) : ie(p);
  }
  function B(n, o) {
    for (var r = (new Date(n, o, 1).getDay() - e.l10n.firstDayOfWeek + 7) % 7, l = e.utils.getDaysInMonth((o - 1 + 12) % 12, n), p = e.utils.getDaysInMonth(o, n), w = window.document.createDocumentFragment(), j = e.config.showMonths > 1, y = j ? "prevMonthDay hidden" : "prevMonthDay", T = j ? "nextMonthDay hidden" : "nextMonthDay", b = l + 1 - r, E = 0; b <= l; b++, E++)
      w.appendChild(re("flatpickr-day " + y, new Date(n, o - 1, b), b, E));
    for (b = 1; b <= p; b++, E++)
      w.appendChild(re("flatpickr-day", new Date(n, o, b), b, E));
    for (var P = p + 1; P <= 42 - r && (e.config.showMonths === 1 || E % 7 !== 0); P++, E++)
      w.appendChild(re("flatpickr-day " + T, new Date(n, o + 1, P % p), P, E));
    var ue = O("div", "dayContainer");
    return ue.appendChild(w), ue;
  }
  function L() {
    if (e.daysContainer !== void 0) {
      ...
      e.daysContainer.appendChild(n), e.days = e.daysContainer.firstChild, e.config.mode === "range" && e.selectedDates.length === 1 && Ne();
    }
  }
  function z() {
    if (!(e.config.showMonths > 1 || e.config.monthSelectorType !== "dropdown")) {
      ...
      for (var o = 0; o < 12; o++)
        if (n(o)) {
          ...
          r.value = new Date(e.currentYear, o).getMonth().toString(), r.textContent = Ge(o, e.config.shorthandCurrentMonth, e.l10n), r.tabIndex = -1, e.currentMonth === o && (r.selected = !0), e.monthsDropdownContainer.appendChild(r);
        }
    }
  }
  function fe() {
    var n = O("div", "flatpickr-month"), o = window.document.createDocumentFragment(), r;
    e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? r = O("span", "cur-month") : (e.monthsDropdownContainer = O("select", "flatpickr-monthDropdown-months"), e.monthsDropdownContainer.setAttribute("aria-label", e.l10n.monthAriaLabel), _(e.monthsDropdownContainer, "change", function(j) {
      var y = ne(j), T = parseInt(y.value, 10);
      e.changeMonth(T - e.currentMonth), V("onMonthChange");
    }), z(), r = e.monthsDropdownContainer);
    var l = Re("cur-year", { tabindex: "-1" }), p = l.getElementsByTagName("input")[0];
  ...
  function he() {
    return e.monthNav = O("div", "flatpickr-months"), e.yearElements = [], e.monthElements = [], e.prevMonthNav = O("span", "flatpickr-prev-month"), e.prevMonthNav.innerHTML = e.config.prevArrow, e.nextMonthNav = O("span", "flatpickr-next-month"), e.nextMonthNav.innerHTML = e.config.nextArrow, xe(), Object.defineProperty(e, "_hidePrevMonthArrow", {
      get: function() {
        return e.__hidePrevMonthArrow;
      },
      set: function(n) {
        e.__hidePrevMonthArrow !== n && (Z(e.prevMonthNav, "flatpickr-disabled", n), e.__hidePrevMonthArrow = n);
      }
      ...
      set: function(n) {
        e.__hideNextMonthArrow !== n && (Z(e.nextMonthNav, "flatpickr-disabled", n), e.__hideNextMonthArrow = n);
      }
    }), e.currentYearElement = e.yearElements[0], ze(), e.monthNav;
  }
  function ke() {
    e.calendarContainer.classList.add("hasTime"), e.config.noCalendar && e.calendarContainer.classList.add("noCalendar");
    var n = rt(e.config);
    e.timeContainer = O("div", "flatpickr-time"), e.timeContainer.tabIndex = -1;
    var o = O("span", "flatpickr-time-separator", ":"), r = Re("flatpickr-hour", {
      "aria-label": e.l10n.hourAriaLabel
    });
    e.hourElement = r.getElementsByTagName("input")[0];
    var l = Re("flatpickr-minute", {
      "aria-label": e.l10n.minuteAriaLabel
    });
    if (e.minuteElement = l.getElementsByTagName("input")[0], e.hourElement.tabIndex = e.minuteElement.tabIndex = -1, e.hourElement.value = X(e.latestSelectedDateObj ? e.latestSelectedDateObj.getHours() : e.config.time_24hr ? n.hours : i(n.hours)), e.minuteElement.value = X(e.latestSelectedDateObj ? e.latestSelectedDateObj.getMinutes() : n.minutes), e.hourElement.setAttribute("step", e.config.hourIncrement.toString()), e.minuteElement.setAttribute("step", e.config.minuteIncrement.toString()), e.hourElement.setAttribute("min", e.config.time_24hr ? "0" : "1"), e.hourElement.setAttribute("max", e.config.time_24hr ? "23" : "12"), e.hourElement.setAttribute("maxlength", "2"), e.minuteElement.setAttribute("min", "0"), e.minuteElement.setAttribute("max", "59"), e.minuteElement.setAttribute("maxlength", "2"), e.timeContainer.appendChild(r), e.timeContainer.appendChild(o), e.timeContainer.appendChild(l), e.config.time_24hr && e.timeContainer.classList.add("time24hr"), e.config.enableSeconds) {
      e.timeContainer.classList.add("hasSeconds");
      var p = Re("flatpickr-second");
    ...
    return e.config.time_24hr || (e.amPM = O("span", "flatpickr-am-pm", e.l10n.amPM[se((e.latestSelectedDateObj ? e.hourElement.value : e.config.defaultHour) > 11)]), e.amPM.title = e.l10n.toggleTitle, e.amPM.tabIndex = -1, e.timeContainer.appendChild(e.amPM)), e.timeContainer;
  }
  function Fe() {
    e.weekdayContainer ? Ve(e.weekdayContainer) : e.weekdayContainer = O("div", "flatpickr-weekdays");
    for (var n = e.config.showMonths; n--; ) {
  ...
  function C() {
    if (e.weekdayContainer) {
      var n = e.l10n.firstDayOfWeek, o = bt(e.l10n.weekdays.shorthand);
      n > 0 && n < o.length && (o = bt(o.splice(n, o.length), o.splice(0, n)));
  ...
  function q(n, o) {
    ...
    r < 0 && e._hidePrevMonthArrow === !0 || r > 0 && e._hideNextMonthArrow === !0 || (e.currentMonth += r, (e.currentMonth < 0 || e.currentMonth > 11) && (e.currentYear += e.currentMonth > 11 ? 1 : -1, e.currentMonth = (e.currentMonth + 12) % 12, V("onYearChange"), z()), L(), V("onMonthChange"), ze());
  }
  function K(n, o) {
    if (n === void 0 && (n = !0), o === void 0 && (o = !0), e.input.value = "", e.altInput !== void 0 && (e.altInput.value = ""), e.mobileInput !== void 0 && (e.mobileInput.value = ""), e.selectedDates = [], e.latestSelectedDateObj = void 0, o === !0 && (e.currentYear = e._initialDate.getFullYear(), e.currentMonth = e._initialDate.getMonth()), e.config.enableTime === !0) {
      var r = rt(e.config), l = r.hours, p = r.minutes, w = r.seconds;
      D(l, p, w);
    }
  ...
  function Ue(n) {
    if (e.isOpen && !e.config.inline) {
      var o = ne(n), r = je(o), l = o === e.input || o === e.altInput || e.element.contains(o) || n.path && n.path.indexOf && (~n.path.indexOf(e.input) || ~n.path.indexOf(e.altInput)), p = !l && !r && !je(n.relatedTarget), w = !e.config.ignoredFocusElements.some(function(j) {
        return j.contains(o);
      });
      p && w && (e.config.allowInput && e.setDate(e._input.value, !1, e.config.altInput ? e.config.altFormat : e.config.dateFormat), e.timeContainer !== void 0 && e.minuteElement !== void 0 && e.hourElement !== void 0 && e.input.value !== "" && e.input.value !== void 0 && h(), e.close(), e.config && e.config.mode === "range" && e.selectedDates.length === 1 && e.clear(!1));
    }
  }
  function Oe(n) {
  ...
  function be(n, o) {
    ...
    if (e.config.minDate && l && oe(l, e.config.minDate, o !== void 0 ? o : !e.minDateHasTime) < 0 || e.config.maxDate && l && oe(l, e.config.maxDate, o !== void 0 ? o : !e.maxDateHasTime) > 0)
      return !1;
    if (!e.config.enable && e.config.disable.length === 0)
      return !0;
    if (l === void 0)
      return !1;
    for (var p = !!e.config.enable, w = (r = e.config.enable) !== null && r !== void 0 ? r : e.config.disable, j = 0, y = void 0; j < w.length; j++) {
  ...
  function Et(n) {
    var o = n.target === e._input, r = e._input.value.trimEnd() !== Xe();
    o && r && !(n.relatedTarget && je(n.relatedTarget)) && e.setDate(e._input.value, !0, n.target === e.altInput ? e.config.altFormat : e.config.dateFormat);
  }
  function ct(n) {
    var o = ne(n), r = e.config.wrap ? t.contains(o) : o === e._input, l = e.config.allowInput, p = e.isOpen && (!l || !r), w = e.config.inline && r && !l;
    if (n.keyCode === 13 && r) {
      if (l)
      ...
      switch (n.keyCode) {
        ...
        case 39:
          if (!j && !r) {
            n.preventDefault();
            var y = c();
            if (e.daysContainer !== void 0 && (l === !1 || y && Ie(y))) {
              var T = n.keyCode === 39 ? 1 : -1;
              n.ctrlKey ? (n.stopPropagation(), q(T), M(de(1), 0)) : M(void 0, T);
            }
        ...
        case 40:
          ...
          e.daysContainer && o.$i !== void 0 || o === e.input || o === e.altInput ? n.ctrlKey ? (n.stopPropagation(), Oe(e.currentYear - b), M(de(1), 0)) : j || M(void 0, b * 7) : o === e.currentYearElement ? Oe(e.currentYear - b) : e.config.enableTime && (!j && e.hourElement && e.hourElement.focus(), h(n), e._debouncedChange());
          break;
        case 9:
          if (j) {
            var E = [
    ...
    if (e.amPM !== void 0 && o === e.amPM)
      switch (n.key) {
        ...
        case e.l10n.amPM[0].charAt(0).toLowerCase():
          e.amPM.textContent = e.l10n.amPM[0], m(), ge();
          break;
        case e.l10n.amPM[1].charAt(0):
        case e.l10n.amPM[1].charAt(0).toLowerCase():
          e.amPM.textContent = e.l10n.amPM[1], m(), ge();
          break;
      }
    (r || je(o)) && V("onKeyDown", n);
  }
  function Ne(n, o) {
    if (o === void 0 && (o = "flatpickr-day"), !(e.selectedDates.length !== 1 || n && (!n.classList.contains(o) || n.classList.contains("flatpickr-disabled")))) {
      for (var r = n ? n.dateObj.getTime() : e.days.firstElementChild.dateObj.getTime(), l = e.parseDate(e.selectedDates[0], void 0, !0).getTime(), p = Math.min(r, e.selectedDates[0].getTime()), w = Math.max(r, e.selectedDates[0].getTime()), j = !1, y = 0, T = 0, b = p; b < w; b += No.DAY)
        be(new Date(b), !0) || (j = j || b > p && b < w, b < l && (!y || b > y) ? y = b : b > l && (!T || b < T) && (T = b));
      var E = Array.from(e.rContainer.querySelectorAll("*:nth-child(-n+" + e.config.showMonths + ") > ." + o));
      E.forEach(function(P) {
        var ue = P.dateObj, te = ue.getTime(), Te = y > 0 && te < y || T > 0 && te > T;
        if (Te) {
          P.classList.add("notAllowed"), ["inRange", "startRange", "endRange"].forEach(function(Me) {
            P.classList.remove(Me);
          });
          return;
        } else if (j && !Te)
          return;
        ["startRange", "inRange", "endRange", "notAllowed"].forEach(function(Me) {
          P.classList.remove(Me);
        }), n !== void 0 && (n.classList.add(r <= e.selectedDates[0].getTime() ? "startRange" : "endRange"), l < r && te === l ? P.classList.add("startRange") : l > r && te === l && P.classList.add("endRange"), te >= y && (T === 0 || te <= T) && Oo(te, l, r) && P.classList.add("inRange"));
      });
    }
  }
  function St() {
  ...
  function Ht(n, o) {
    if (o === void 0 && (o = e._positionElement), e.isMobile === !0) {
      ...
      return;
    var l = e.isOpen;
    e.isOpen = !0, l || (e.calendarContainer.classList.add("open"), e._input.classList.add("active"), V("onOpen"), Ye(o)), e.config.enableTime === !0 && e.config.noCalendar === !0 && e.config.allowInput === !1 && (n === void 0 || !e.timeContainer.contains(n.relatedTarget)) && setTimeout(function() {
  ...
  function ut(n) {
    return function(o) {
      ...
      r !== void 0 && (e[n === "min" ? "minDateHasTime" : "maxDateHasTime"] = r.getHours() > 0 || r.getMinutes() > 0 || r.getSeconds() > 0), e.selectedDates && (e.selectedDates = e.selectedDates.filter(function(p) {
        return be(p);
      }), !e.selectedDates.length && n === "min" && H(r), ge()), e.daysContainer && (gt(), r !== void 0 ? e.currentYearElement[n] = r.getFullYear().toString() : e.currentYearElement.removeAttribute(n), e.currentYearElement.disabled = !!l && r !== void 0 && l.getFullYear() === r.getFullYear());
    };
  }
  function jt() {
    var n = [
    ...
    var j = function(E) {
      return function(P) {
        e.config[E === "min" ? "_minTime" : "_maxTime"] = e.parseDate(P, "H:i:S");
      };
    };
    ...
    tt.filter(function(E) {
      ...
      e.config[E] = nt(e.config[E] || []).map(f);
    }), e.isMobile = !e.config.disableMobile && !e.config.inline && e.config.mode === "single" && !e.config.disable.length && !e.config.enable && !e.config.weekNumbers && /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
    for (var y = 0; y < e.config.plugins.length; y++) {
      var T = e.config.plugins[y](e) || {};
      for (var b in T)
        tt.indexOf(b) > -1 ? e.config[b] = nt(T[b]).map(f).concat(e.config[b]) : typeof o[b] > "u" && (e.config[b] = T[b]);
    }
    o.altInputClass || (e.config.altInputClass = ft().className + " " + e.config.altInputClass), V("onParseConfig");
  }
  function ft() {
    return e.config.wrap ? t.querySelector("[data-input]") : t;
  }
  function ht() {
    typeof e.config.locale != "object" && typeof G.l10ns[e.config.locale] > "u" && e.config.errorHandler(new Error("flatpickr: invalid locale " + e.config.locale)), e.l10n = U(U({}, G.l10ns.default), typeof e.config.locale == "object" ? e.config.locale : e.config.locale !== "default" ? G.l10ns[e.config.locale] : void 0), ye.D = "(" + e.l10n.weekdays.shorthand.join("|") + ")", ye.l = "(" + e.l10n.weekdays.longhand.join("|") + ")", ye.M = "(" + e.l10n.months.shorthand.join("|") + ")", ye.F = "(" + e.l10n.months.longhand.join("|") + ")", ye.K = "(" + e.l10n.amPM[0] + "|" + e.l10n.amPM[1] + "|" + e.l10n.amPM[0].toLowerCase() + "|" + e.l10n.amPM[1].toLowerCase() + ")";
    var n = U(U({}, a), JSON.parse(JSON.stringify(t.dataset || {})));
    n.time_24hr === void 0 && G.defaultConfig.time_24hr === void 0 && (e.config.time_24hr = e.l10n.time_24hr), e.formatDate = Ct(e), e.parseDate = lt({ config: e.config, l10n: e.l10n });
  }
  function Ye(n) {
    ...
    if (e.calendarContainer !== void 0) {
      ...
      }, 0), l = e.calendarContainer.offsetWidth, p = e.config.position.split(" "), w = p[0], j = p.length > 1 ? p[1] : null, y = o.getBoundingClientRect(), T = window.innerHeight - y.bottom, b = w === "above" || w !== "below" && T < r && y.top > r, E = window.pageYOffset + y.top + (b ? -r - 2 : o.offsetHeight + 2);
      if (Z(e.calendarContainer, "arrowTop", !b), Z(e.calendarContainer, "arrowBottom", b), !e.config.inline) {
        var P = window.pageXOffset + y.left, ue = !1, te = !1;
        j === "center" ? (P -= (l - y.width) / 2, ue = !0) : j === "right" && (P -= l - y.width, te = !0), Z(e.calendarContainer, "arrowLeft", !ue && !te), Z(e.calendarContainer, "arrowCenter", ue), Z(e.calendarContainer, "arrowRight", te);
        var Te = window.document.body.offsetWidth - (window.pageXOffset + y.right), Me = P + l > window.document.body.offsetWidth, zt = Te + l > window.document.body.offsetWidth;
        if (Z(e.calendarContainer, "rightMost", Me), !e.config.static)
          if (e.calendarContainer.style.top = E + "px", !Me)
            e.calendarContainer.style.left = P + "px", e.calendarContainer.style.right = "auto";
          else if (!zt)
            ...
            if (et === void 0)
              return;
            var Vt = window.document.body.offsetWidth, Rt = Math.max(0, Vt / 2 - l / 2), Wt = ".flatpickr-calendar.centerMost:before", Kt = ".flatpickr-calendar.centerMost:after", Gt = et.cssRules.length, qt = "{left:" + y.left + "px;right:auto;}";
            Z(e.calendarContainer, "rightMost", !1), Z(e.calendarContainer, "centerMost", !0), et.insertRule(Wt + "," + Kt + qt, Gt), e.calendarContainer.style.left = Rt + "px", e.calendarContainer.style.right = "auto";
          }
      }
    }
  }
  ...
  function gt() {
    e.config.noCalendar || e.isMobile || (z(), ze(), L());
  }
  function Je() {
  ...
  function pt(n) {
    ...
    if (r !== void 0) {
      ...
      if (e.selectedDateElem = l, e.config.mode === "single")
        ...
        var j = Qe(p);
        j ? e.selectedDates.splice(parseInt(j), 1) : e.selectedDates.push(p);
      } else e.config.mode === "range" && (e.selectedDates.length === 2 && e.clear(!1, !1), e.latestSelectedDateObj = p, e.selectedDates.push(p), oe(p, e.selectedDates[0], !0) !== 0 && e.selectedDates.sort(function(E, P) {
      ...
      if (ze(), L(), ge(), !w && e.config.mode !== "range" && e.config.showMonths === 1 ? ie(l) : e.selectedDateElem !== void 0 && e.hourElement === void 0 && e.selectedDateElem && e.selectedDateElem.focus(), e.hourElement !== void 0 && e.hourElement !== void 0 && e.hourElement.focus(), e.config.closeOnSelect) {
  ...
  function Bt(n, o) {
    if (n !== null && typeof n == "object") {
      ...
      for (var r in n)
        Pe[r] !== void 0 && Pe[r].forEach(function(l) {
          return l();
        });
    } else
      e.config[n] = o, Pe[n] !== void 0 ? Pe[n].forEach(function(l) {
        return l();
      }) : tt.indexOf(n) > -1 && (e.config[n] = nt(o));
    e.redraw(), ge(!0);
  }
  function mt(n, o) {
    var r = [];
    ...
    e.selectedDates = e.config.allowInvalidPreload ? r : r.filter(function(l) {
      return l instanceof Date && be(l, !1);
  ...
  function $t(n, o, r) {
    if (o === void 0 && (o = !1), r === void 0 && (r = e.config.dateFormat), n !== 0 && !n || n instanceof Array && n.length === 0)
      return e.clear(o);
    mt(n, r), e.latestSelectedDateObj = e.selectedDates[e.selectedDates.length - 1], e.redraw(), J(void 0, o), H(), e.selectedDates.length === 0 && e.clear(!1), ge(o), o && V("onChange");
  }
  function vt(n) {
  ...
  function Ot() {
    ...
    _(e.mobileInput, "change", function(o) {
      e.setDate(ne(o).value, !1, e.mobileFormatStr), V("onChange"), V("onClose");
    });
  }
  function It(n) {
    if (e.isOpen === !0)
  ...
  function V(n, o) {
    if (e.config !== void 0) {
      ...
      n === "onChange" && (e.input.dispatchEvent(Ze("change")), e.input.dispatchEvent(Ze("input")));
    }
  }
  function Ze(n) {
  ...
  function Qe(n) {
    for (var o = 0; o < e.selectedDates.length; o++) {
      ...
      if (r instanceof Date && oe(r, n) === 0)
        return "" + o;
    }
    return !1;
  }
  function Nt(n) {
    return e.config.mode !== "range" || e.selectedDates.length < 2 ? !1 : oe(n, e.selectedDates[0]) >= 0 && oe(n, e.selectedDates[1]) <= 0;
  }
  function ze() {
    e.config.noCalendar || e.isMobile || !e.monthNav || (e.yearElements.forEach(function(n, o) {
      var r = new Date(e.currentYear, e.currentMonth, 1);
      r.setMonth(e.currentMonth + o), e.config.showMonths > 1 || e.config.monthSelectorType === "static" ? e.monthElements[o].textContent = Ge(r.getMonth(), e.config.shorthandCurrentMonth, e.l10n) + " " : e.monthsDropdownContainer.value = r.getMonth().toString(), n.value = r.getFullYear().toString();
  ...
  function ge(n) {
    n === void 0 && (n = !0), e.mobileInput !== void 0 && e.mobileFormatStr && (e.mobileInput.value = e.latestSelectedDateObj !== void 0 ? e.formatDate(e.latestSelectedDateObj, e.mobileFormatStr) : ""), e.input.value = Xe(e.config.dateFormat), e.altInput !== void 0 && (e.altInput.value = Xe(e.config.altFormat)), n !== !1 && V("onValueUpdate");
  }
  function Yt(n) {
    var o = ne(n), r = e.prevMonthNav.contains(o), l = e.nextMonthNav.contains(o);
    r || l ? q(r ? -1 : 1) : e.yearElements.indexOf(o) >= 0 ? o.select() : o.classList.contains("arrowUp") ? e.changeYear(e.currentYear + 1) : o.classList.contains("arrowDown") && e.changeYear(e.currentYear - 1);
  }
  function Pt(n) {
    n.preventDefault();
    var o = n.type === "keydown", r = ne(n), l = r;
    e.amPM !== void 0 && r === e.amPM && (e.amPM.textContent = e.l10n.amPM[se(e.amPM.textContent === e.l10n.amPM[0])]);
    var p = parseFloat(l.getAttribute("min")), w = parseFloat(l.getAttribute("max")), j = parseFloat(l.getAttribute("step")), y = parseInt(l.value, 10), T = n.delta || (o ? n.which === 38 ? 1 : -1 : 0), b = y + j * T;
    if (typeof l.value < "u" && l.value.length === 2) {
      var E = l === e.hourElement, P = l === e.minuteElement;
      b < p ? (b = w + b + se(!E) + (se(E) && se(!e.amPM)), P && le(void 0, -1, e.hourElement)) : b > w && (b = l === e.hourElement ? b - w - se(!e.amPM) : p, P && le(void 0, 1, e.hourElement)), e.amPM && E && (j === 1 ? b + y === 23 : Math.abs(b - y) > j) && (e.amPM.textContent = e.l10n.amPM[se(e.amPM.textContent === e.l10n.amPM[0])]), l.value = X(b);
    }
  }
  return d(), e;
}
...
G.localize = function(t) {
  G.l10ns.default = U(U({}, G.l10ns.default), t);
};
G.setDefaults = function(t) {
  G.defaultConfig = U(U({}, G.defaultConfig), t);
};
G.parseDate = lt({});
G.formatDate = Ct({});
G.compareDates = oe;
  ...
  (function(e, u) {
    ...
    var e = function() {
      return e = Object.assign || function(x) {
        for (var i, m = 1, H = arguments.length; m < H; m++) {
          i = arguments[m];
      ...
      return i.months[x ? "shorthand" : "longhand"][h];
    };
    function d(h) {
      for (; h.firstChild; )
    ...
    function s(h) {
      ...
      return function(i) {
        ...
        function H() {
          if (i.rContainer) {
            d(i.rContainer);
            for (var M = 0; M < i.monthElements.length; M++) {
              var B = i.monthElements[M];
        ...
        function S() {
          if (m.monthsContainer) {
            ...
            for (var M = document.createDocumentFragment(), B = 0; B < 12; B++) {
              var L = i.createDay("flatpickr-monthSelect-month", new Date(i.currentYear, B), 0, B);
              L.dateObj.getMonth() === (/* @__PURE__ */ new Date()).getMonth() && L.dateObj.getFullYear() === (/* @__PURE__ */ new Date()).getFullYear() && L.classList.add("today"), L.textContent = u(B, x.shorthand, i.l10n), L.addEventListener("click", J), M.appendChild(L);
            }
            m.monthsContainer.appendChild(M), i.config.minDate && i.currentYear === i.config.minDate.getFullYear() ? i.prevMonthNav.classList.add("flatpickr-disabled") : i.prevMonthNav.classList.remove("flatpickr-disabled"), i.config.maxDate && i.currentYear === i.config.maxDate.getFullYear() ? i.nextMonthNav.classList.add("flatpickr-disabled") : i.nextMonthNav.classList.remove("flatpickr-disabled");
          }
        }
        function _() {
          i._bind(i.prevMonthNav, "click", function(M) {
            M.preventDefault(), M.stopPropagation(), i.changeYear(i.currentYear - 1), Q(), S();
          }), i._bind(i.nextMonthNav, "click", function(M) {
            M.preventDefault(), M.stopPropagation(), i.changeYear(i.currentYear + 1), Q(), S();
          }), i._bind(m.monthsContainer, "mouseover", function(M) {
            i.config.mode === "range" && i.onMouseOver(c(M), "flatpickr-monthSelect-month");
          });
        }
        function A() {
          if (i.rContainer && i.selectedDates.length) {
            for (var M = i.rContainer.querySelectorAll(".flatpickr-monthSelect-month.selected"), B = 0; B < M.length; B++)
              M[B].classList.remove("selected");
            var L = i.selectedDates[0].getMonth(), z = i.rContainer.querySelector(".flatpickr-monthSelect-month:nth-child(" + (L + 1) + ")");
            z && z.classList.add("selected");
          }
        }
        function Q() {
          var M = i.selectedDates[0];
          if (M && (M = new Date(M), M.setFullYear(i.currentYear), i.config.minDate && M < i.config.minDate && (M = i.config.minDate), i.config.maxDate && M > i.config.maxDate && (M = i.config.maxDate), i.currentYear = M.getFullYear()), i.currentYearElement.value = String(i.currentYear), i.rContainer) {
            var B = i.rContainer.querySelectorAll(".flatpickr-monthSelect-month");
            B.forEach(function(L) {
              L.dateObj.setFullYear(i.currentYear), i.config.minDate && L.dateObj < i.config.minDate || i.config.maxDate && L.dateObj > i.config.maxDate ? L.classList.add("flatpickr-disabled") : L.classList.remove("flatpickr-disabled");
            });
          }
          A();
        }
        function J(M) {
          ...
          var B = c(M);
          if (B instanceof Element && !B.classList.contains("flatpickr-disabled") && !B.classList.contains("notAllowed") && (ae(B.dateObj), i.config.closeOnSelect)) {
            var L = i.config.mode === "single", z = i.config.mode === "range" && i.selectedDates.length === 2;
            (L || z) && i.close();
          }
        }
        function ae(M) {
          var B = new Date(i.currentYear, M.getMonth(), M.getDate()), L = [];
          switch (i.config.mode) {
            ...
            case "multiple":
              ...
              break;
            case "range":
              i.selectedDates.length === 2 ? L = [B] : (L = i.selectedDates.concat([B]), L.sort(function(z, fe) {
        ...
        function we(M, B, L, z) {
          var fe = le[z.keyCode] !== void 0;
          if (!(!fe && z.keyCode !== 13) && !(!i.rContainer || !m.monthsContainer)) {
            var xe = i.rContainer.querySelector(".flatpickr-monthSelect-month.selected"), he = Array.prototype.indexOf.call(m.monthsContainer.children, document.activeElement);
            if (he === -1) {
              var ke = xe || m.monthsContainer.firstElementChild;
              ke.focus(), he = ke.$i;
            }
            fe ? m.monthsContainer.children[(12 + he + le[z.keyCode]) % 12].focus() : z.keyCode === 13 && m.monthsContainer.contains(document.activeElement) && ae(document.activeElement.dateObj);
          }
        }
        function re() {
          var M;
          ((M = i.config) === null || M === void 0 ? void 0 : M.mode) === "range" && i.selectedDates.length === 1 && i.clear(!1), i.selectedDates.length || S();
        }
        function ie() {
        ...
        function me() {
          if (m.monthsContainer !== null)
            for (var M = m.monthsContainer.querySelectorAll(".flatpickr-monthSelect-month"), B = 0; B < M.length; B++)
              M[B].removeEventListener("click", J);
        }
        return {
          ...
          onReady: [
            ...
            A,
            function() {
              i.config.onClose.push(re), i.loadedPlugins.push("monthSelect");
            }
          ],
          onDestroy: [
            de,
            me,
            function() {
              i.config.onClose = i.config.onClose.filter(function(M) {
                return M !== re;
              });
            }
          ]
...
const Wo = /* @__PURE__ */ Vo(Ro), Ko = { class: "relative" }, Go = ["placeholder", "disabled", "readonly"], qo = {
  ...
  emits: ["update:modelValue"],
  setup(t, { emit: a }) {
    const e = t, u = a, d = ee(null), c = ee(!1), f = ee((/* @__PURE__ */ new Date()).getFullYear() - 6);
    let s = null;
    const h = $(() => e.picker === "month" ? e.dateFormat || "Y-m" : e.picker === "year" ? e.dateFormat || "Y" : e.dateFormat ? e.dateFormat : e.noCalendar ? "H:i" : e.enableTime ? "Y-m-d H:i" : "Y-m-d"), x = () => {
      var S, _;
      if (d.value) {
        ...
        (_ = s == null ? void 0 : s.destroy) == null || _.call(s), s = G(d.value, {
          mode: e.mode,
          ...
          onChange: (A) => {
            if (e.mode === "range") {
              ...
              const Q = A[0] ? s.formatDate(A[0], h.value) : "";
              u("update:modelValue", Q);
            }
          }
        });
    ...
    const m = $(
      () => Array.from({ length: 12 }, (S, _) => f.value + _)
    ), H = (S) => {
    ...
    return it(() => document.addEventListener("click", D)), st(() => document.removeEventListener("click", D)), (S, _) => (v(), k("div", Ko, [
      g("input", {
        ref_key: "inputEl",
        ref: d,
      ...
      t.picker === "year-grid" && c.value ? (v(), k("div", qo, [
        g("div", Uo, [
          g("button", {
            ...
            type: "button",
            onClick: _[0] || (_[0] = (A) => f.value -= 12)
          }, " Prev "),
          g("div", Jo, I(f.value) + " - " + I(f.value + 11), 1),
          g("button", {
            class: "btn btn-ghost btn-xs",
            type: "button",
            onClick: _[1] || (_[1] = (A) => f.value += 12)
          }, " Next ")
        ]),
        g("div", Zo, [
          (v(!0), k(pe, null, Se(m.value, (A) => (v(), k("button", {
            key: A,
            class: F(["btn btn-ghost btn-xs", { "btn-primary": t.modelValue === A.toString() }]),
            type: "button",
            onClick: (Q) => H(A)
          }, I(A), 11, Qo))), 128))
        ])
  ...
  emits: ["grid-ready"],
  setup(t, { emit: a }) {
    const e = t, u = a, d = an(), c = ee(null), f = ee(null), s = ee(13), h = ee(!1);
    let x = null, i = null;
    const m = [
      "modelUpdated",
      "paginationChanged",
    ...
    ]), _ = $(() => D.value === "autoHeight" ? { height: "auto" } : { height: e.normalLayoutHeight }), A = () => {
      const C = document.documentElement, Y = C.classList.contains("dark"), q = (C.getAttribute("data-theme") || "").toLowerCase() === "mitrekadark";
      h.value = Y || q;
    }, Q = $(() => e.themeMode === "dark" ? !0 : e.themeMode === "light" ? !1 : h.value), J = $(() => Q.value ? "ag-theme-quartz-dark" : "ag-theme-quartz"), ae = $(() => e.density === "compact" ? "agx-compact" : e.density === "spacious" ? "agx-spacious" : ""), le = $(() => ["agx", J.value, ae.value, d.class]), we = $(() => [{ "--ag-odd-row-background-color": e.striped ? Q.value ? "#0d1a33" : "#F3F4F6" : "transparent" }, d.style]), re = $(() => {
      const { class: C, style: Y, onGridReady: q, ...K } = d;
      return K;
    }), ie = (C) => typeof C == "number" && Number.isFinite(C) ? C : void 0, de = $(() => {
      const C = d.gridOptions;
      if (C && typeof C == "object") return C;
      const Y = d["grid-options"];
      return Y && typeof Y == "object" ? Y : {};
    }), me = (C) => {
      const Y = ie(d[C]);
      if (typeof Y == "number") return Y;
      const K = ie(d[C === "headerHeight" ? "header-height" : "group-header-height"]);
      return typeof K == "number" ? K : ie(de.value[C]);
    }, M = () => {
      const C = d.domLayout;
      if (typeof C == "string" && C.length > 0) return C;
      const Y = d["dom-layout"];
      if (typeof Y == "string" && Y.length > 0) return Y;
      const q = de.value.domLayout;
      return typeof q == "string" && q.length > 0 ? q : void 0;
    }, B = () => {
      var Y, q;
      if (!f.value) return 0;
      const C = (K) => typeof K == "number" && Number.isFinite(K) && K >= 0;
      if (typeof f.value.getDisplayedRowCount == "function") {
        const K = f.value.getDisplayedRowCount();
        if (C(K)) return K;
      }
      if (typeof f.value.paginationGetRowCount == "function") {
        const K = f.value.paginationGetRowCount();
        if (C(K)) return K;
      }
      if (typeof f.value.getModel == "function") {
        const K = (q = (Y = f.value).getModel) == null ? void 0 : q.call(Y), Le = K && typeof K.getRowCount == "function" ? K.getRowCount() : void 0;
        if (C(Le)) return Le;
      }
      return 0;
    }, L = () => {
      ...
      const C = M();
      if (C) {
        D.value = C, f.value.setGridOption("domLayout", C);
        return;
      }
      const Y = e.autoHeightWhenFewRows && B() < L() ? "autoHeight" : "normal";
      D.value = Y, f.value.setGridOption("domLayout", Y);
    }, fe = () => {
      var C;
      for (; H.length > 0; )
        (C = H.pop()) == null || C();
      ...
      const C = () => z();
      m.forEach((Y) => {
        f.value.addEventListener(Y, C), H.push(() => {
          var q;
          (q = f.value) == null || q.removeEventListener(Y, C);
        });
      });
    }, he = () => {
      if (!e.autoHeaderHeight || !f.value) return;
      const C = me("headerHeight") ?? cn(e.density), Y = me("groupHeaderHeight") ?? un(e.density);
      f.value.setGridOption("headerHeight", C), f.value.setGridOption("groupHeaderHeight", Y);
    }, ke = () => {
      if (!e.autoRowHeight || !f.value) return;
      const C = fn(s.value, e.density);
      f.value.setGridOption("rowHeight", C), f.value.setGridOption("getRowHeight", () => C), f.value.resetRowHeights();
    }, Fe = (C) => {
      f.value = C.api, s.value = hn(c.value), xe(), he(), z(), ke(), requestAnimationFrame(() => z()), u("grid-ready", C);
    };
    return ce(
      () => e.density,
      () => {
        var C;
        he(), ke(), (C = f.value) == null || C.refreshCells({ force: !0 });
      }
    ), ce(
      () => [
        d.headerHeight,
      ...
      x == null || x.disconnect(), fe(), i == null || i();
    }), (C, Y) => (v(), k("div", {
      ref_key: "hostRef",
      ref: c,
      class: F(S.value),
