    ...
    <div class="flex-1 flex items-center justify-center p-6 md:p-12">
      <div class="w-full max-w-md space-y-8">
        ...
        <div class="text-center">
          ...
          <p class="text-sm opacity-60 mt-1">Masuk ke akun Anda untuk melanjutkan</p>
        </div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-5">
          ...
          <div>
            ...
            <div class="relative">
              ...
              >
                <Icon :name="showPassword ? 'eye' : 'eye'" class="w-5 h-5" />
              </button>
            </div>
          </div>
      ...
      <div class="relative z-10 flex items-center justify-center p-12 w-full">
        <div class="max-w-md text-white">
          ...
          <p class="opacity-90 mb-8 text-lg">
            Sistem desain modern untuk membangun aplikasi yang konsisten dan mudah di-maintain.
          </p>
          <div class="flex items-center gap-4">
            ...
            <p class="text-sm opacity-90">Dipercaya oleh 100+ developer</p>
          </div>
        </div>
      </div>
    </div>
